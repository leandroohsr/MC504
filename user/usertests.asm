...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	37278793          	add	a5,a5,882 # 7380 <malloc+0x2470>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	f8a50513          	add	a0,a0,-118 # 4ff0 <malloc+0xe0>
      6e:	5ef040ef          	jal	4e5c <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	f7050513          	add	a0,a0,-144 # 5010 <malloc+0x100>
      a8:	5b5040ef          	jal	4e5c <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	f6850513          	add	a0,a0,-152 # 5028 <malloc+0x118>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	f7250513          	add	a0,a0,-142 # 5048 <malloc+0x138>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	f3e50513          	add	a0,a0,-194 # 5030 <malloc+0x120>
      fa:	563040ef          	jal	4e5c <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	f5250513          	add	a0,a0,-174 # 5058 <malloc+0x148>
     10e:	54f040ef          	jal	4e5c <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	f0450513          	add	a0,a0,-252 # 5080 <malloc+0x170>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	efa50513          	add	a0,a0,-262 # 50a0 <malloc+0x190>
     1ae:	4af040ef          	jal	4e5c <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	e1650513          	add	a0,a0,-490 # 50d8 <malloc+0x1c8>
     2ca:	393040ef          	jal	4e5c <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	e1c50513          	add	a0,a0,-484 # 50f8 <malloc+0x1e8>
     2e4:	379040ef          	jal	4e5c <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	e1250513          	add	a0,a0,-494 # 5110 <malloc+0x200>
     306:	754040ef          	jal	4a5a <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	e0298993          	add	s3,s3,-510 # 5110 <malloc+0x200>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	dc650513          	add	a0,a0,-570 # 5110 <malloc+0x200>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	d3a58593          	add	a1,a1,-710 # 5098 <malloc+0x188>
     366:	6c4040ef          	jal	4a2a <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	dc050513          	add	a0,a0,-576 # 5130 <malloc+0x220>
     378:	2e5040ef          	jal	4e5c <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	68c040ef          	jal	4a0a <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	d9650513          	add	a0,a0,-618 # 5118 <malloc+0x208>
     38a:	2d3040ef          	jal	4e5c <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	67a040ef          	jal	4a0a <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	d8450513          	add	a0,a0,-636 # 5118 <malloc+0x208>
     39c:	2c1040ef          	jal	4e5c <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	d6450513          	add	a0,a0,-668 # 5110 <malloc+0x200>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	ef078793          	add	a5,a5,-272 # 7380 <malloc+0x2470>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	c82a0a13          	add	s4,s4,-894 # 5140 <malloc+0x230>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	c0450513          	add	a0,a0,-1020 # 5148 <malloc+0x238>
     54c:	111040ef          	jal	4e5c <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	c0650513          	add	a0,a0,-1018 # 5160 <malloc+0x250>
     562:	0fb040ef          	jal	4e5c <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	c2050513          	add	a0,a0,-992 # 5190 <malloc+0x280>
     578:	0e5040ef          	jal	4e5c <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	48c040ef          	jal	4a0a <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	c3e50513          	add	a0,a0,-962 # 51c0 <malloc+0x2b0>
     58a:	0d3040ef          	jal	4e5c <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	c3850513          	add	a0,a0,-968 # 51d0 <malloc+0x2c0>
     5a0:	0bd040ef          	jal	4e5c <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	dc278793          	add	a5,a5,-574 # 7380 <malloc+0x2470>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	c0ea0a13          	add	s4,s4,-1010 # 5200 <malloc+0x2f0>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	a9ea8a93          	add	s5,s5,-1378 # 5098 <malloc+0x188>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	b8a50513          	add	a0,a0,-1142 # 5208 <malloc+0x2f8>
     686:	7d6040ef          	jal	4e5c <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	b8c50513          	add	a0,a0,-1140 # 5220 <malloc+0x310>
     69c:	7c0040ef          	jal	4e5c <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	368040ef          	jal	4a0a <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	b1a50513          	add	a0,a0,-1254 # 51c0 <malloc+0x2b0>
     6ae:	7ae040ef          	jal	4e5c <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	356040ef          	jal	4a0a <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	b9850513          	add	a0,a0,-1128 # 5250 <malloc+0x340>
     6c0:	79c040ef          	jal	4e5c <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	b9a50513          	add	a0,a0,-1126 # 5268 <malloc+0x358>
     6d6:	786040ef          	jal	4e5c <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	95850513          	add	a0,a0,-1704 # 5080 <malloc+0x170>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	93450513          	add	a0,a0,-1740 # 5080 <malloc+0x170>
     754:	2f6040ef          	jal	4a4a <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	92450513          	add	a0,a0,-1756 # 5080 <malloc+0x170>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	b6a58593          	add	a1,a1,-1174 # 52f8 <malloc+0x3e8>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	8bc50513          	add	a0,a0,-1860 # 5080 <malloc+0x170>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	aa050513          	add	a0,a0,-1376 # 5298 <malloc+0x388>
     800:	65c040ef          	jal	4e5c <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	aac50513          	add	a0,a0,-1364 # 52b8 <malloc+0x3a8>
     814:	648040ef          	jal	4e5c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	aac50513          	add	a0,a0,-1364 # 52c8 <malloc+0x3b8>
     824:	638040ef          	jal	4e5c <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	ab850513          	add	a0,a0,-1352 # 52e8 <malloc+0x3d8>
     838:	624040ef          	jal	4e5c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	a8850513          	add	a0,a0,-1400 # 52c8 <malloc+0x3b8>
     848:	614040ef          	jal	4e5c <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	aaa50513          	add	a0,a0,-1366 # 5300 <malloc+0x3f0>
     85e:	5fe040ef          	jal	4e5c <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	ab450513          	add	a0,a0,-1356 # 5320 <malloc+0x410>
     874:	5e8040ef          	jal	4e5c <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	aa850513          	add	a0,a0,-1368 # 5340 <malloc+0x430>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	abc98993          	add	s3,s3,-1348 # 5368 <malloc+0x458>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	aeca8a93          	add	s5,s5,-1300 # 53a0 <malloc+0x490>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	a5250513          	add	a0,a0,-1454 # 5340 <malloc+0x430>
  ...
  if(unlink("small") < 0){
     ...
     922:	a2250513          	add	a0,a0,-1502 # 5340 <malloc+0x430>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	a0450513          	add	a0,a0,-1532 # 5348 <malloc+0x438>
     94c:	510040ef          	jal	4e5c <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	a1e50513          	add	a0,a0,-1506 # 5378 <malloc+0x468>
     962:	4fa040ef          	jal	4e5c <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	a4050513          	add	a0,a0,-1472 # 53b0 <malloc+0x4a0>
     978:	4e4040ef          	jal	4e5c <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	a5450513          	add	a0,a0,-1452 # 53d8 <malloc+0x4c8>
     98c:	4d0040ef          	jal	4e5c <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	a6050513          	add	a0,a0,-1440 # 53f8 <malloc+0x4e8>
     9a0:	4bc040ef          	jal	4e5c <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	a6450513          	add	a0,a0,-1436 # 5410 <malloc+0x500>
     9b4:	4a8040ef          	jal	4e5c <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	a5a50513          	add	a0,a0,-1446 # 5430 <malloc+0x520>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	a1450513          	add	a0,a0,-1516 # 5430 <malloc+0x520>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	9dc50513          	add	a0,a0,-1572 # 5438 <malloc+0x528>
     a64:	3f8040ef          	jal	4e5c <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	9e650513          	add	a0,a0,-1562 # 5458 <malloc+0x548>
     a7a:	3e2040ef          	jal	4e5c <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	9fa50513          	add	a0,a0,-1542 # 5480 <malloc+0x570>
     a8e:	3ce040ef          	jal	4e5c <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	98a50513          	add	a0,a0,-1654 # 5430 <malloc+0x520>
     ...
     ad0:	9d450513          	add	a0,a0,-1580 # 54a0 <malloc+0x590>
     ad4:	388040ef          	jal	4e5c <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	9e650513          	add	a0,a0,-1562 # 54c8 <malloc+0x5b8>
     aea:	372040ef          	jal	4e5c <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	9e850513          	add	a0,a0,-1560 # 54e0 <malloc+0x5d0>
     b00:	35c040ef          	jal	4e5c <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	9fc50513          	add	a0,a0,-1540 # 5508 <malloc+0x5f8>
     b14:	348040ef          	jal	4e5c <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	9ee50513          	add	a0,a0,-1554 # 5520 <malloc+0x610>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	a0a58593          	add	a1,a1,-1526 # 5550 <malloc+0x640>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	9c650513          	add	a0,a0,-1594 # 5520 <malloc+0x610>
  ...
  unlink("unlinkread");
     ...
     be6:	93e50513          	add	a0,a0,-1730 # 5520 <malloc+0x610>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	93250513          	add	a0,a0,-1742 # 5530 <malloc+0x620>
     c06:	256040ef          	jal	4e5c <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	94650513          	add	a0,a0,-1722 # 5558 <malloc+0x648>
     c1a:	242040ef          	jal	4e5c <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	95250513          	add	a0,a0,-1710 # 5578 <malloc+0x668>
     c2e:	22e040ef          	jal	4e5c <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	96650513          	add	a0,a0,-1690 # 55a0 <malloc+0x690>
     c42:	21a040ef          	jal	4e5c <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	97250513          	add	a0,a0,-1678 # 55c0 <malloc+0x6b0>
     c56:	206040ef          	jal	4e5c <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	97e50513          	add	a0,a0,-1666 # 55e0 <malloc+0x6d0>
     c6a:	1f2040ef          	jal	4e5c <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	97e50513          	add	a0,a0,-1666 # 5600 <malloc+0x6f0>
     c8a:	5d1030ef          	jal	4a5a <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	97a50513          	add	a0,a0,-1670 # 5608 <malloc+0x6f8>
     c96:	5c5030ef          	jal	4a5a <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	96250513          	add	a0,a0,-1694 # 5600 <malloc+0x6f0>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	89e58593          	add	a1,a1,-1890 # 5550 <malloc+0x640>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	88650513          	add	a0,a0,-1914 # 5610 <malloc+0x700>
     d92:	0ca040ef          	jal	4e5c <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	88a50513          	add	a0,a0,-1910 # 5628 <malloc+0x718>
     da6:	0b6040ef          	jal	4e5c <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	88e50513          	add	a0,a0,-1906 # 5640 <malloc+0x730>
     dba:	0a2040ef          	jal	4e5c <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	89a50513          	add	a0,a0,-1894 # 5660 <malloc+0x750>
     dce:	08e040ef          	jal	4e5c <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	8b650513          	add	a0,a0,-1866 # 5690 <malloc+0x780>
     de2:	07a040ef          	jal	4e5c <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	8ba50513          	add	a0,a0,-1862 # 56a8 <malloc+0x798>
     df6:	066040ef          	jal	4e5c <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	8be50513          	add	a0,a0,-1858 # 56c0 <malloc+0x7b0>
     e0a:	052040ef          	jal	4e5c <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	8d250513          	add	a0,a0,-1838 # 56e8 <malloc+0x7d8>
     e1e:	03e040ef          	jal	4e5c <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	8ee50513          	add	a0,a0,-1810 # 5718 <malloc+0x808>
     e32:	02a040ef          	jal	4e5c <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	8e498993          	add	s3,s3,-1820 # 5738 <malloc+0x828>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	8bc50513          	add	a0,a0,-1860 # 5748 <malloc+0x838>
     e94:	7c9030ef          	jal	4e5c <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	8b450513          	add	a0,a0,-1868 # 5768 <malloc+0x858>
     ebc:	39f030ef          	jal	4a5a <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	8a450513          	add	a0,a0,-1884 # 5768 <malloc+0x858>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	88aa0a13          	add	s4,s4,-1910 # 5768 <malloc+0x858>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	83c50513          	add	a0,a0,-1988 # 5768 <malloc+0x858>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	7dc50513          	add	a0,a0,2012 # 5770 <malloc+0x860>
     f9c:	6c1030ef          	jal	4e5c <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	7e250513          	add	a0,a0,2018 # 5790 <malloc+0x880>
     fb6:	6a7030ef          	jal	4e5c <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	7f650513          	add	a0,a0,2038 # 57b8 <malloc+0x8a8>
     fca:	693030ef          	jal	4e5c <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	00e98993          	add	s3,s3,14 # 5028 <malloc+0x118>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	87878793          	add	a5,a5,-1928 # 6908 <malloc+0x19f8>
  ...
  if(pid == 0){
    ...
    10e8:	29c78793          	add	a5,a5,668 # 7380 <malloc+0x2470>
    ...
    110c:	f2050513          	add	a0,a0,-224 # 5028 <malloc+0x118>
    ...
    1120:	74450513          	add	a0,a0,1860 # 5860 <malloc+0x950>
    1124:	539030ef          	jal	4e5c <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	6a450513          	add	a0,a0,1700 # 57d8 <malloc+0x8c8>
    113c:	521030ef          	jal	4e5c <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	6ac50513          	add	a0,a0,1708 # 57f8 <malloc+0x8e8>
    1154:	509030ef          	jal	4e5c <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	6b250513          	add	a0,a0,1714 # 5818 <malloc+0x908>
    116e:	4ef030ef          	jal	4e5c <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	6c250513          	add	a0,a0,1730 # 5840 <malloc+0x930>
    1186:	4d7030ef          	jal	4e5c <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	07f030ef          	jal	4a0a <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	c9850513          	add	a0,a0,-872 # 6e28 <malloc+0x1f18>
    1198:	4c5030ef          	jal	4e5c <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	6be50513          	add	a0,a0,1726 # 5888 <malloc+0x978>
    11d2:	48b030ef          	jal	4e5c <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f8:	e8c50513          	add	a0,a0,-372 # 5080 <malloc+0x170>
  ...
  if(pid == 0){
    ...
    1216:	e6ea0a13          	add	s4,s4,-402 # 5080 <malloc+0x170>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	6cea8a93          	add	s5,s5,1742 # 58e8 <malloc+0x9d8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    1272:	64a50513          	add	a0,a0,1610 # 58b8 <malloc+0x9a8>
    1276:	3e7030ef          	jal	4e5c <printf>
    exit(1);
    127a:	4505                	li	a0,1
    ...
    1286:	64e50513          	add	a0,a0,1614 # 58d0 <malloc+0x9c0>
    128a:	3d3030ef          	jal	4e5c <printf>
        exit(1);
    128e:	4505                	li	a0,1
    ...
    129c:	66050513          	add	a0,a0,1632 # 58f8 <malloc+0x9e8>
    12a0:	3bd030ef          	jal	4e5c <printf>
        exit(1);
    12a4:	4505                	li	a0,1
    ...
    12b2:	dd2a0a13          	add	s4,s4,-558 # 5080 <malloc+0x170>
    int n = write(fd, "xxx", 3);
    12b6:	00004a97          	auipc	s5,0x4
    12ba:	662a8a93          	add	s5,s5,1634 # 5918 <malloc+0xa08>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    12f4:	d9050513          	add	a0,a0,-624 # 5080 <malloc+0x170>
  ...
  exit(xstatus);
    ...
    130a:	5ca50513          	add	a0,a0,1482 # 58d0 <malloc+0x9c0>
    130e:	34f030ef          	jal	4e5c <printf>
      exit(1);
    1312:	4505                	li	a0,1
    ...
    1320:	60450513          	add	a0,a0,1540 # 5920 <malloc+0xa10>
    1324:	339030ef          	jal	4e5c <printf>
      exit(1);
    1328:	4505                	li	a0,1
...
000000000000132e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1340:	cec78793          	add	a5,a5,-788 # 5028 <malloc+0x118>
    1344:	fcf43023          	sd	a5,-64(s0)
    1348:	00004797          	auipc	a5,0x4
    134c:	5f878793          	add	a5,a5,1528 # 5940 <malloc+0xa30>
    1350:	fcf43423          	sd	a5,-56(s0)
    1354:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1358:	00004517          	auipc	a0,0x4
    135c:	5f050513          	add	a0,a0,1520 # 5948 <malloc+0xa38>
  ...
  if(pid == 0) {
    ...
    137e:	5ce50513          	add	a0,a0,1486 # 5948 <malloc+0xa38>
    ...
    1396:	5d650513          	add	a0,a0,1494 # 5968 <malloc+0xa58>
    139a:	2c3030ef          	jal	4e5c <printf>
      exit(1);
    139e:	4505                	li	a0,1
    ...
    13aa:	51250513          	add	a0,a0,1298 # 58b8 <malloc+0x9a8>
    13ae:	2af030ef          	jal	4e5c <printf>
     exit(1);
    13b2:	4505                	li	a0,1
    ...
    13be:	59650513          	add	a0,a0,1430 # 5950 <malloc+0xa40>
    13c2:	29b030ef          	jal	4e5c <printf>
      exit(1);
    13c6:	4505                	li	a0,1
    ...
    13d4:	c5850513          	add	a0,a0,-936 # 5028 <malloc+0x118>
  ...
  if(xstatus != 0)
    ...
    13fc:	58050513          	add	a0,a0,1408 # 5978 <malloc+0xa68>
    1400:	25d030ef          	jal	4e5c <printf>
      exit(1);
    1404:	4505                	li	a0,1
    ...
    1410:	58450513          	add	a0,a0,1412 # 5990 <malloc+0xa80>
    1414:	249030ef          	jal	4e5c <printf>
    1418:	bfd1                	j	13ec <exectest+0xbe>
  fd = open("echo-ok", O_RDONLY);
    141a:	4581                	li	a1,0
    141c:	00004517          	auipc	a0,0x4
    1420:	52c50513          	add	a0,a0,1324 # 5948 <malloc+0xa38>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1442:	fba50513          	add	a0,a0,-70 # 53f8 <malloc+0x4e8>
    1446:	217030ef          	jal	4e5c <printf>
    exit(1);
    144a:	4505                	li	a0,1
    ...
    1456:	47e50513          	add	a0,a0,1150 # 58d0 <malloc+0x9c0>
    145a:	203030ef          	jal	4e5c <printf>
    exit(1);
    145e:	4505                	li	a0,1
    1460:	5aa030ef          	jal	4a0a <exit>
  unlink("echo-ok");
    1464:	00004517          	auipc	a0,0x4
    1468:	4e450513          	add	a0,a0,1252 # 5948 <malloc+0xa38>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    148e:	51e50513          	add	a0,a0,1310 # 59a8 <malloc+0xa98>
    1492:	1cb030ef          	jal	4e5c <printf>
    exit(1);
    1496:	4505                	li	a0,1
...
00000000000014a2 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1532:	49250513          	add	a0,a0,1170 # 59c0 <malloc+0xab0>
    1536:	127030ef          	jal	4e5c <printf>
    exit(1);
    153a:	4505                	li	a0,1
    ...
    1560:	42da8a93          	add	s5,s5,1069 # 142d <exectest+0xff>
{
    ...
    15a4:	43850513          	add	a0,a0,1080 # 59d8 <malloc+0xac8>
    15a8:	0b5030ef          	jal	4e5c <printf>
        exit(1);
    15ac:	4505                	li	a0,1
    ...
    15b8:	43c50513          	add	a0,a0,1084 # 59f0 <malloc+0xae0>
    15bc:	0a1030ef          	jal	4e5c <printf>
}
    ...
    15e8:	42450513          	add	a0,a0,1060 # 5a08 <malloc+0xaf8>
    15ec:	071030ef          	jal	4e5c <printf>
      exit(1);
    15f0:	4505                	li	a0,1
    ...
    1614:	41850513          	add	a0,a0,1048 # 5a28 <malloc+0xb18>
    1618:	045030ef          	jal	4e5c <printf>
    exit(1);
    161c:	4505                	li	a0,1
...
0000000000001622 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1676:	24650513          	add	a0,a0,582 # 58b8 <malloc+0x9a8>
    167a:	7e2030ef          	jal	4e5c <printf>
      exit(1);
    167e:	4505                	li	a0,1
    ...
    168a:	3ba50513          	add	a0,a0,954 # 5a40 <malloc+0xb30>
    168e:	7ce030ef          	jal	4e5c <printf>
        exit(1);
    1692:	4505                	li	a0,1
    ...
    169e:	3be50513          	add	a0,a0,958 # 5a58 <malloc+0xb48>
    16a2:	7ba030ef          	jal	4e5c <printf>
        exit(1);
    16a6:	4505                	li	a0,1
...
00000000000016b2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    16fa:	1c250513          	add	a0,a0,450 # 58b8 <malloc+0x9a8>
    16fe:	75e030ef          	jal	4e5c <printf>
      exit(1);
    1702:	4505                	li	a0,1
    ...
    1712:	1aa50513          	add	a0,a0,426 # 58b8 <malloc+0x9a8>
    1716:	746030ef          	jal	4e5c <printf>
        exit(1);
    171a:	4505                	li	a0,1
...
0000000000001724 <forkfork>:
{
    ...
    1770:	30c50513          	add	a0,a0,780 # 5a78 <malloc+0xb68>
    1774:	6e8030ef          	jal	4e5c <printf>
      exit(1);
    1778:	4505                	li	a0,1
    177a:	290030ef          	jal	4a0a <exit>
{
    ...
    17ac:	2e050513          	add	a0,a0,736 # 5a88 <malloc+0xb78>
    17b0:	6ac030ef          	jal	4e5c <printf>
      exit(1);
    17b4:	4505                	li	a0,1
...
00000000000017ba <reparent2>:
{
  ...
  exit(0);
    ...
    17e6:	64650513          	add	a0,a0,1606 # 6e28 <malloc+0x1f18>
    17ea:	672030ef          	jal	4e5c <printf>
      exit(1);
    17ee:	4505                	li	a0,1
...
0000000000001802 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1868:	05450513          	add	a0,a0,84 # 58b8 <malloc+0x9a8>
    186c:	5f0030ef          	jal	4e5c <printf>
      exit(1);
    1870:	4505                	li	a0,1
    ...
    188c:	0c850513          	add	a0,a0,200 # 5950 <malloc+0xa40>
    1890:	5cc030ef          	jal	4e5c <printf>
          exit(1);
    1894:	4505                	li	a0,1
    ...
    18ea:	1c250513          	add	a0,a0,450 # 5aa8 <malloc+0xb98>
    18ee:	56e030ef          	jal	4e5c <printf>
            exit(1);
    18f2:	4505                	li	a0,1
    ...
    190e:	1b650513          	add	a0,a0,438 # 5ac0 <malloc+0xbb0>
    1912:	54a030ef          	jal	4e5c <printf>
        exit(1);
    1916:	4505                	li	a0,1
    ...
    1964:	18850513          	add	a0,a0,392 # 5ae8 <malloc+0xbd8>
    1968:	4f4030ef          	jal	4e5c <printf>
        exit(1);
    196c:	4505                	li	a0,1
...
00000000000019da <linkunlink>:
{
  ...
  unlink("x");
    ...
    19fa:	6a250513          	add	a0,a0,1698 # 5098 <malloc+0x188>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a2e:	66ea8a93          	add	s5,s5,1646 # 5098 <malloc+0x188>
      link("cat", "x");
    1a32:	00004b97          	auipc	s7,0x4
    1a36:	0deb8b93          	add	s7,s7,222 # 5b10 <malloc+0xc00>
    1a3a:	a025                	j	1a62 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a3c:	85a6                	mv	a1,s1
    1a3e:	00004517          	auipc	a0,0x4
    1a42:	e7a50513          	add	a0,a0,-390 # 58b8 <malloc+0x9a8>
    1a46:	416030ef          	jal	4e5c <printf>
    exit(1);
    1a4a:	4505                	li	a0,1
...
0000000000001ab4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1ae0:	05450513          	add	a0,a0,84 # 5b30 <malloc+0xc20>
    1ae4:	378030ef          	jal	4e5c <printf>
    exit(1);
    1ae8:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1b2e:	fee50513          	add	a0,a0,-18 # 5b18 <malloc+0xc08>
    1b32:	32a030ef          	jal	4e5c <printf>
    exit(1);
    1b36:	4505                	li	a0,1
    ...
    1b42:	01a50513          	add	a0,a0,26 # 5b58 <malloc+0xc48>
    1b46:	316030ef          	jal	4e5c <printf>
      exit(1);
    1b4a:	4505                	li	a0,1
    ...
    1b56:	01e50513          	add	a0,a0,30 # 5b70 <malloc+0xc60>
    1b5a:	302030ef          	jal	4e5c <printf>
    exit(1);
    1b5e:	4505                	li	a0,1
...
0000000000001b64 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bc6:	cf650513          	add	a0,a0,-778 # 58b8 <malloc+0x9a8>
    1bca:	292030ef          	jal	4e5c <printf>
      exit(1);
    1bce:	4505                	li	a0,1
    ...
    1be0:	fac50513          	add	a0,a0,-84 # 5b88 <malloc+0xc78>
    1be4:	278030ef          	jal	4e5c <printf>
      exit(1);
    1be8:	4505                	li	a0,1
...
0000000000001bf4 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c4e:	c6e50513          	add	a0,a0,-914 # 58b8 <malloc+0x9a8>
    1c52:	20a030ef          	jal	4e5c <printf>
      exit(1);
    1c56:	4505                	li	a0,1
    ...
    1c72:	f3a50513          	add	a0,a0,-198 # 5ba8 <malloc+0xc98>
    1c76:	1e6030ef          	jal	4e5c <printf>
      exit(1);
    1c7a:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cc2:	f0250513          	add	a0,a0,-254 # 5bc0 <malloc+0xcb0>
    1cc6:	196030ef          	jal	4e5c <printf>
    exit(1);
    1cca:	4505                	li	a0,1
    ...
    1cd6:	be650513          	add	a0,a0,-1050 # 58b8 <malloc+0x9a8>
    1cda:	182030ef          	jal	4e5c <printf>
    exit(1);
    1cde:	4505                	li	a0,1
...
0000000000001cea <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1cfe:	68678793          	add	a5,a5,1670 # 7380 <malloc+0x2470>
  ...
  exit(0);
    ...
    1d66:	e8650513          	add	a0,a0,-378 # 5be8 <malloc+0xcd8>
    1d6a:	0f2030ef          	jal	4e5c <printf>
      exit(0);
    1d6e:	4501                	li	a0,0
    ...
    1d7a:	b4250513          	add	a0,a0,-1214 # 58b8 <malloc+0x9a8>
    1d7e:	0de030ef          	jal	4e5c <printf>
      exit(1);
    1d82:	4505                	li	a0,1
...
0000000000001d8e <manywrites>:
{
  ...
  exit(0);
    ...
    1dde:	04e50513          	add	a0,a0,78 # 6e28 <malloc+0x1f18>
    1de2:	07a030ef          	jal	4e5c <printf>
      exit(1);
    1de6:	4505                	li	a0,1
    ...
    1e6a:	da250513          	add	a0,a0,-606 # 5c08 <malloc+0xcf8>
    1e6e:	7ef020ef          	jal	4e5c <printf>
            exit(1);
    1e72:	4505                	li	a0,1
    ...
    1e82:	27a50513          	add	a0,a0,634 # 50f8 <malloc+0x1e8>
    1e86:	7d7020ef          	jal	4e5c <printf>
            exit(1);
    1e8a:	4505                	li	a0,1
...
0000000000001e94 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1ef6:	a1678793          	add	a5,a5,-1514 # 6908 <malloc+0x19f8>
  ...
  if(ret != -1){
    ...
    1f30:	cf450513          	add	a0,a0,-780 # 5c20 <malloc+0xd10>
    1f34:	729020ef          	jal	4e5c <printf>
    exit(1);
    1f38:	4505                	li	a0,1
    ...
    1f46:	89650513          	add	a0,a0,-1898 # 57d8 <malloc+0x8c8>
    1f4a:	713020ef          	jal	4e5c <printf>
    exit(1);
    1f4e:	4505                	li	a0,1
    ...
    1f5c:	8a050513          	add	a0,a0,-1888 # 57f8 <malloc+0x8e8>
    1f60:	6fd020ef          	jal	4e5c <printf>
    exit(1);
    1f64:	4505                	li	a0,1
    ...
    1f74:	8a850513          	add	a0,a0,-1880 # 5818 <malloc+0x908>
    1f78:	6e5020ef          	jal	4e5c <printf>
    exit(1);
    1f7c:	4505                	li	a0,1
    ...
    1f8a:	8ba50513          	add	a0,a0,-1862 # 5840 <malloc+0x930>
    1f8e:	6cf020ef          	jal	4e5c <printf>
    exit(1);
    1f92:	4505                	li	a0,1
...
0000000000001f98 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1fc6:	c9e50513          	add	a0,a0,-866 # 5c60 <malloc+0xd50>
  ...
  if(n >= 0){
    ...
    1fee:	c9650513          	add	a0,a0,-874 # 5c80 <malloc+0xd70>
    1ff2:	66b020ef          	jal	4e5c <printf>
    exit(1);
    1ff6:	4505                	li	a0,1
    1ff8:	213020ef          	jal	4a0a <exit>
    printf("sbrk(rwsbrk) failed\n");
    1ffc:	00004517          	auipc	a0,0x4
    2000:	c2c50513          	add	a0,a0,-980 # 5c28 <malloc+0xd18>
    2004:	659020ef          	jal	4e5c <printf>
    exit(1);
    2008:	4505                	li	a0,1
    200a:	201020ef          	jal	4a0a <exit>
    printf("sbrk(rwsbrk) shrink failed\n");
    200e:	00004517          	auipc	a0,0x4
    2012:	c3250513          	add	a0,a0,-974 # 5c40 <malloc+0xd30>
    2016:	647020ef          	jal	4e5c <printf>
    exit(1);
    201a:	4505                	li	a0,1
    201c:	1ef020ef          	jal	4a0a <exit>
    printf("open(rwsbrk) failed\n");
    2020:	00004517          	auipc	a0,0x4
    2024:	c4850513          	add	a0,a0,-952 # 5c68 <malloc+0xd58>
    2028:	635020ef          	jal	4e5c <printf>
    exit(1);
    202c:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    203c:	c2850513          	add	a0,a0,-984 # 5c60 <malloc+0xd50>
    2040:	21b020ef          	jal	4a5a <unlink>
  fd = open("README", O_RDONLY);
    2044:	4581                	li	a1,0
    2046:	00003517          	auipc	a0,0x3
    204a:	1ba50513          	add	a0,a0,442 # 5200 <malloc+0x2f0>
  ...
  if(n >= 0){
    ...
    206c:	c4850513          	add	a0,a0,-952 # 5cb0 <malloc+0xda0>
    2070:	5ed020ef          	jal	4e5c <printf>
    exit(1);
    2074:	4505                	li	a0,1
    2076:	195020ef          	jal	4a0a <exit>
    printf("open(rwsbrk) failed\n");
    207a:	00004517          	auipc	a0,0x4
    207e:	bee50513          	add	a0,a0,-1042 # 5c68 <malloc+0xd58>
    2082:	5db020ef          	jal	4e5c <printf>
    exit(1);
    2086:	4505                	li	a0,1
...
0000000000002098 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    20e2:	bfa50513          	add	a0,a0,-1030 # 5cd8 <malloc+0xdc8>
    20e6:	577020ef          	jal	4e5c <printf>
    exit(1);
    20ea:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2120:	bdc50513          	add	a0,a0,-1060 # 5cf8 <malloc+0xde8>
    2124:	539020ef          	jal	4e5c <printf>
    exit(1);
    2128:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    216c:	bf050513          	add	a0,a0,-1040 # 5d58 <malloc+0xe48>
    2170:	4ed020ef          	jal	4e5c <printf>
    exit(1);
    2174:	4505                	li	a0,1
    ...
    2186:	b9650513          	add	a0,a0,-1130 # 5d18 <malloc+0xe08>
    218a:	4d3020ef          	jal	4e5c <printf>
      exit(1);
    218e:	4505                	li	a0,1
    ...
    219a:	ba250513          	add	a0,a0,-1118 # 5d38 <malloc+0xe28>
    219e:	4bf020ef          	jal	4e5c <printf>
    exit(1);
    21a2:	4505                	li	a0,1
...
00000000000021c2 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    229c:	ae050513          	add	a0,a0,-1312 # 5d78 <malloc+0xe68>
    22a0:	3bd020ef          	jal	4e5c <printf>
    exit(1);
    22a4:	4505                	li	a0,1
    ...
    22b0:	b1450513          	add	a0,a0,-1260 # 5dc0 <malloc+0xeb0>
    22b4:	3a9020ef          	jal	4e5c <printf>
    exit(1);
    22b8:	4505                	li	a0,1
    ...
    22c8:	b1c50513          	add	a0,a0,-1252 # 5de0 <malloc+0xed0>
    22cc:	391020ef          	jal	4e5c <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e0:	b4450513          	add	a0,a0,-1212 # 5e20 <malloc+0xf10>
    22e4:	379020ef          	jal	4e5c <printf>
    exit(1);
    22e8:	4505                	li	a0,1
    ...
    22f4:	b6050513          	add	a0,a0,-1184 # 5e50 <malloc+0xf40>
    22f8:	365020ef          	jal	4e5c <printf>
    exit(1);
    22fc:	4505                	li	a0,1
    ...
    230c:	b8050513          	add	a0,a0,-1152 # 5e88 <malloc+0xf78>
    2310:	34d020ef          	jal	4e5c <printf>
    exit(1);
    2314:	4505                	li	a0,1
...
000000000000231a <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    233a:	b7a50513          	add	a0,a0,-1158 # 5eb0 <malloc+0xfa0>
    233e:	70c020ef          	jal	4a4a <open>
    2342:	84aa                	mv	s1,a0
  unlink("sbrk");
    2344:	00004517          	auipc	a0,0x4
    2348:	b6c50513          	add	a0,a0,-1172 # 5eb0 <malloc+0xfa0>
  ...
  if(pipe((int *) a) != 0){
    ...
    2388:	b3450513          	add	a0,a0,-1228 # 5eb8 <malloc+0xfa8>
    238c:	2d1020ef          	jal	4e5c <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    239c:	b3850513          	add	a0,a0,-1224 # 5ed0 <malloc+0xfc0>
    23a0:	2bd020ef          	jal	4e5c <printf>
    exit(1);
    23a4:	4505                	li	a0,1
    ...
    23b0:	61450513          	add	a0,a0,1556 # 59c0 <malloc+0xab0>
    23b4:	2a9020ef          	jal	4e5c <printf>
    exit(1);
    23b8:	4505                	li	a0,1
...
00000000000023be <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    23d2:	b1a50513          	add	a0,a0,-1254 # 5ee8 <malloc+0xfd8>
  ...
  close(fd);
    ...
    240a:	4ca50513          	add	a0,a0,1226 # 58d0 <malloc+0x9c0>
    240e:	24f020ef          	jal	4e5c <printf>
    exit(1);
    2412:	4505                	li	a0,1
...
0000000000002418 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2440:	9ec50513          	add	a0,a0,-1556 # 6e28 <malloc+0x1f18>
    2444:	219020ef          	jal	4e5c <printf>
    exit(1);
    2448:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    247a:	9b250513          	add	a0,a0,-1614 # 6e28 <malloc+0x1f18>
    247e:	1df020ef          	jal	4e5c <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24ba:	97250513          	add	a0,a0,-1678 # 6e28 <malloc+0x1f18>
    24be:	19f020ef          	jal	4e5c <printf>
    exit(1);
    24c2:	4505                	li	a0,1
...
00000000000025a4 <execout>:
{
  ...
  exit(0);
    ...
    25da:	85250513          	add	a0,a0,-1966 # 6e28 <malloc+0x1f18>
    25de:	07f020ef          	jal	4e5c <printf>
      exit(1);
    25e2:	4505                	li	a0,1
    ...
    261a:	a1250513          	add	a0,a0,-1518 # 5028 <malloc+0x118>
    261e:	faa43c23          	sd	a0,-72(s0)
    2622:	00003797          	auipc	a5,0x3
    2626:	a7678793          	add	a5,a5,-1418 # 5098 <malloc+0x188>
...
0000000000002640 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2670:	90450513          	add	a0,a0,-1788 # 5f70 <malloc+0x1060>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2686:	96650513          	add	a0,a0,-1690 # 5fe8 <malloc+0x10d8>
  ...
  unlink("12345678901234");
    ...
    270a:	7ea50513          	add	a0,a0,2026 # 5ef0 <malloc+0xfe0>
    270e:	74e020ef          	jal	4e5c <printf>
    exit(1);
    2712:	4505                	li	a0,1
    ...
    271e:	81e50513          	add	a0,a0,-2018 # 5f38 <malloc+0x1028>
    2722:	73a020ef          	jal	4e5c <printf>
    exit(1);
    2726:	4505                	li	a0,1
    ...
    2732:	87250513          	add	a0,a0,-1934 # 5fa0 <malloc+0x1090>
    2736:	726020ef          	jal	4e5c <printf>
    exit(1);
    273a:	4505                	li	a0,1
    ...
    2746:	8d650513          	add	a0,a0,-1834 # 6018 <malloc+0x1108>
    274a:	712020ef          	jal	4e5c <printf>
    exit(1);
    274e:	4505                	li	a0,1
    ...
    275a:	92250513          	add	a0,a0,-1758 # 6078 <malloc+0x1168>
    275e:	6fe020ef          	jal	4e5c <printf>
    exit(1);
    2762:	4505                	li	a0,1
    ...
    276e:	96650513          	add	a0,a0,-1690 # 60d0 <malloc+0x11c0>
    2772:	6ea020ef          	jal	4e5c <printf>
    exit(1);
    2776:	4505                	li	a0,1
...
000000000000277c <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27b6:	95650513          	add	a0,a0,-1706 # 6108 <malloc+0x11f8>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    27e2:	93a50513          	add	a0,a0,-1734 # 6118 <malloc+0x1208>
    27e6:	676020ef          	jal	4e5c <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2986:	7b650513          	add	a0,a0,1974 # 6138 <malloc+0x1228>
    298a:	4d2020ef          	jal	4e5c <printf>
...
0000000000002990 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    29ec:	78850513          	add	a0,a0,1928 # 6170 <malloc+0x1260>
    29f0:	46c020ef          	jal	4e5c <printf>
    exit(1);
    29f4:	4505                	li	a0,1
    ...
    2a00:	78c50513          	add	a0,a0,1932 # 6188 <malloc+0x1278>
    2a04:	458020ef          	jal	4e5c <printf>
    exit(1);
    2a08:	4505                	li	a0,1
    ...
    2a14:	7a850513          	add	a0,a0,1960 # 61b8 <malloc+0x12a8>
    2a18:	444020ef          	jal	4e5c <printf>
    exit(1);
    2a1c:	4505                	li	a0,1
    ...
    2a28:	7bc50513          	add	a0,a0,1980 # 61e0 <malloc+0x12d0>
    2a2c:	430020ef          	jal	4e5c <printf>
    exit(1);
    2a30:	4505                	li	a0,1
...
0000000000002a36 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a88:	e3450513          	add	a0,a0,-460 # 58b8 <malloc+0x9a8>
    2a8c:	3d0020ef          	jal	4e5c <printf>
    exit(1);
    2a90:	4505                	li	a0,1
    ...
    2a9c:	6d850513          	add	a0,a0,1752 # 6170 <malloc+0x1260>
    2aa0:	3bc020ef          	jal	4e5c <printf>
      exit(1);
    2aa4:	4505                	li	a0,1
    ...
    2ab0:	74c50513          	add	a0,a0,1868 # 61f8 <malloc+0x12e8>
    2ab4:	3a8020ef          	jal	4e5c <printf>
      exit(1);
    2ab8:	4505                	li	a0,1
    ...
    2ac4:	6f850513          	add	a0,a0,1784 # 61b8 <malloc+0x12a8>
    2ac8:	394020ef          	jal	4e5c <printf>
      exit(1);
    2acc:	4505                	li	a0,1
...
0000000000002ae2 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b3e:	63650513          	add	a0,a0,1590 # 6170 <malloc+0x1260>
    2b42:	31a020ef          	jal	4e5c <printf>
    exit(1);
    2b46:	4505                	li	a0,1
    ...
    2b52:	6ca50513          	add	a0,a0,1738 # 6218 <malloc+0x1308>
    2b56:	306020ef          	jal	4e5c <printf>
    exit(1);
    2b5a:	4505                	li	a0,1
    ...
    2b66:	6d650513          	add	a0,a0,1750 # 6238 <malloc+0x1328>
    2b6a:	2f2020ef          	jal	4e5c <printf>
    exit(1);
    2b6e:	4505                	li	a0,1
    ...
    2b7a:	6da50513          	add	a0,a0,1754 # 6250 <malloc+0x1340>
    2b7e:	2de020ef          	jal	4e5c <printf>
    exit(1);
    2b82:	4505                	li	a0,1
...
0000000000002b88 <subdir>:
{
  ...
  unlink("ff");
    ...
    2b9a:	80250513          	add	a0,a0,-2046 # 6398 <malloc+0x1488>
    2b9e:	6bd010ef          	jal	4a5a <unlink>
  if(mkdir("dd") != 0){
    2ba2:	00003517          	auipc	a0,0x3
    2ba6:	6c650513          	add	a0,a0,1734 # 6268 <malloc+0x1358>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bba:	6d250513          	add	a0,a0,1746 # 6288 <malloc+0x1378>
  ...
  write(fd, "ff", 2);
    ...
    2bce:	7ce58593          	add	a1,a1,1998 # 6398 <malloc+0x1488>
  ...
  if(unlink("dd") >= 0){
    ...
    2be0:	68c50513          	add	a0,a0,1676 # 6268 <malloc+0x1358>
    2be4:	677010ef          	jal	4a5a <unlink>
    2be8:	2c055963          	bgez	a0,2eba <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2bec:	00003517          	auipc	a0,0x3
    2bf0:	6f450513          	add	a0,a0,1780 # 62e0 <malloc+0x13d0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c04:	70850513          	add	a0,a0,1800 # 6308 <malloc+0x13f8>
  ...
  write(fd, "FF", 2);
    ...
    2c18:	72458593          	add	a1,a1,1828 # 6338 <malloc+0x1428>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c2c:	71850513          	add	a0,a0,1816 # 6340 <malloc+0x1430>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d12:	5fa50513          	add	a0,a0,1530 # 6308 <malloc+0x13f8>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d26:	7fe50513          	add	a0,a0,2046 # 6520 <malloc+0x1610>
  ...
  if(unlink("dd") < 0){
    ...
    2e98:	3dc50513          	add	a0,a0,988 # 6270 <malloc+0x1360>
    2e9c:	7c1010ef          	jal	4e5c <printf>
    exit(1);
    2ea0:	4505                	li	a0,1
    ...
    2eac:	3e850513          	add	a0,a0,1000 # 6290 <malloc+0x1380>
    2eb0:	7ad010ef          	jal	4e5c <printf>
    exit(1);
    2eb4:	4505                	li	a0,1
    ...
    2ec0:	3f450513          	add	a0,a0,1012 # 62b0 <malloc+0x13a0>
    2ec4:	799010ef          	jal	4e5c <printf>
    exit(1);
    2ec8:	4505                	li	a0,1
    ...
    2ed4:	41850513          	add	a0,a0,1048 # 62e8 <malloc+0x13d8>
    2ed8:	785010ef          	jal	4e5c <printf>
    exit(1);
    2edc:	4505                	li	a0,1
    ...
    2ee8:	43450513          	add	a0,a0,1076 # 6318 <malloc+0x1408>
    2eec:	771010ef          	jal	4e5c <printf>
    exit(1);
    2ef0:	4505                	li	a0,1
    ...
    2efc:	45850513          	add	a0,a0,1112 # 6350 <malloc+0x1440>
    2f00:	75d010ef          	jal	4e5c <printf>
    exit(1);
    2f04:	4505                	li	a0,1
    ...
    2f10:	46450513          	add	a0,a0,1124 # 6370 <malloc+0x1460>
    2f14:	749010ef          	jal	4e5c <printf>
    exit(1);
    2f18:	4505                	li	a0,1
    ...
    2f24:	48050513          	add	a0,a0,1152 # 63a0 <malloc+0x1490>
    2f28:	735010ef          	jal	4e5c <printf>
    exit(1);
    2f2c:	4505                	li	a0,1
    ...
    2f38:	49450513          	add	a0,a0,1172 # 63c8 <malloc+0x14b8>
    2f3c:	721010ef          	jal	4e5c <printf>
    exit(1);
    2f40:	4505                	li	a0,1
    ...
    2f4c:	4a050513          	add	a0,a0,1184 # 63e8 <malloc+0x14d8>
    2f50:	70d010ef          	jal	4e5c <printf>
    exit(1);
    2f54:	4505                	li	a0,1
    ...
    2f60:	4b450513          	add	a0,a0,1204 # 6410 <malloc+0x1500>
    2f64:	6f9010ef          	jal	4e5c <printf>
    exit(1);
    2f68:	4505                	li	a0,1
    ...
    2f74:	4c850513          	add	a0,a0,1224 # 6438 <malloc+0x1528>
    2f78:	6e5010ef          	jal	4e5c <printf>
    exit(1);
    2f7c:	4505                	li	a0,1
    ...
    2f88:	4e450513          	add	a0,a0,1252 # 6468 <malloc+0x1558>
    2f8c:	6d1010ef          	jal	4e5c <printf>
    exit(1);
    2f90:	4505                	li	a0,1
    ...
    2f9c:	50050513          	add	a0,a0,1280 # 6498 <malloc+0x1588>
    2fa0:	6bd010ef          	jal	4e5c <printf>
    exit(1);
    2fa4:	4505                	li	a0,1
    ...
    2fb0:	50450513          	add	a0,a0,1284 # 64b0 <malloc+0x15a0>
    2fb4:	6a9010ef          	jal	4e5c <printf>
    exit(1);
    2fb8:	4505                	li	a0,1
    ...
    2fc4:	51050513          	add	a0,a0,1296 # 64d0 <malloc+0x15c0>
    2fc8:	695010ef          	jal	4e5c <printf>
    exit(1);
    2fcc:	4505                	li	a0,1
    ...
    2fd8:	51c50513          	add	a0,a0,1308 # 64f0 <malloc+0x15e0>
    2fdc:	681010ef          	jal	4e5c <printf>
    exit(1);
    2fe0:	4505                	li	a0,1
    ...
    2fec:	54850513          	add	a0,a0,1352 # 6530 <malloc+0x1620>
    2ff0:	66d010ef          	jal	4e5c <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3000:	56450513          	add	a0,a0,1380 # 6560 <malloc+0x1650>
    3004:	659010ef          	jal	4e5c <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3014:	57050513          	add	a0,a0,1392 # 6580 <malloc+0x1670>
    3018:	645010ef          	jal	4e5c <printf>
    exit(1);
    301c:	4505                	li	a0,1
    ...
    3028:	57c50513          	add	a0,a0,1404 # 65a0 <malloc+0x1690>
    302c:	631010ef          	jal	4e5c <printf>
    exit(1);
    3030:	4505                	li	a0,1
    ...
    303c:	58850513          	add	a0,a0,1416 # 65c0 <malloc+0x16b0>
    3040:	61d010ef          	jal	4e5c <printf>
    exit(1);
    3044:	4505                	li	a0,1
    ...
    3050:	5a450513          	add	a0,a0,1444 # 65f0 <malloc+0x16e0>
    3054:	609010ef          	jal	4e5c <printf>
    exit(1);
    3058:	4505                	li	a0,1
    ...
    3064:	5b850513          	add	a0,a0,1464 # 6618 <malloc+0x1708>
    3068:	5f5010ef          	jal	4e5c <printf>
    exit(1);
    306c:	4505                	li	a0,1
    ...
    3078:	5cc50513          	add	a0,a0,1484 # 6640 <malloc+0x1730>
    307c:	5e1010ef          	jal	4e5c <printf>
    exit(1);
    3080:	4505                	li	a0,1
    ...
    308c:	5e050513          	add	a0,a0,1504 # 6668 <malloc+0x1758>
    3090:	5cd010ef          	jal	4e5c <printf>
    exit(1);
    3094:	4505                	li	a0,1
    ...
    30a0:	5ec50513          	add	a0,a0,1516 # 6688 <malloc+0x1778>
    30a4:	5b9010ef          	jal	4e5c <printf>
    exit(1);
    30a8:	4505                	li	a0,1
    ...
    30b4:	5f850513          	add	a0,a0,1528 # 66a8 <malloc+0x1798>
    30b8:	5a5010ef          	jal	4e5c <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30c8:	60c50513          	add	a0,a0,1548 # 66d0 <malloc+0x17c0>
    30cc:	591010ef          	jal	4e5c <printf>
    exit(1);
    30d0:	4505                	li	a0,1
    ...
    30dc:	61850513          	add	a0,a0,1560 # 66f0 <malloc+0x17e0>
    30e0:	57d010ef          	jal	4e5c <printf>
    exit(1);
    30e4:	4505                	li	a0,1
    ...
    30f0:	62450513          	add	a0,a0,1572 # 6710 <malloc+0x1800>
    30f4:	569010ef          	jal	4e5c <printf>
    exit(1);
    30f8:	4505                	li	a0,1
    ...
    3104:	63850513          	add	a0,a0,1592 # 6738 <malloc+0x1828>
    3108:	555010ef          	jal	4e5c <printf>
    exit(1);
    310c:	4505                	li	a0,1
    ...
    3118:	2b450513          	add	a0,a0,692 # 63c8 <malloc+0x14b8>
    311c:	541010ef          	jal	4e5c <printf>
    exit(1);
    3120:	4505                	li	a0,1
    ...
    312c:	63050513          	add	a0,a0,1584 # 6758 <malloc+0x1848>
    3130:	52d010ef          	jal	4e5c <printf>
    exit(1);
    3134:	4505                	li	a0,1
    ...
    3140:	63c50513          	add	a0,a0,1596 # 6778 <malloc+0x1868>
    3144:	519010ef          	jal	4e5c <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3154:	65850513          	add	a0,a0,1624 # 67a8 <malloc+0x1898>
    3158:	505010ef          	jal	4e5c <printf>
    exit(1);
    315c:	4505                	li	a0,1
    ...
    3168:	66450513          	add	a0,a0,1636 # 67c8 <malloc+0x18b8>
    316c:	4f1010ef          	jal	4e5c <printf>
    exit(1);
    3170:	4505                	li	a0,1
...
0000000000003176 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3202:	5ea50513          	add	a0,a0,1514 # 67e8 <malloc+0x18d8>
    3206:	457010ef          	jal	4e5c <printf>
    exit(1);
    320a:	4505                	li	a0,1
    ...
    3216:	5ee50513          	add	a0,a0,1518 # 6800 <malloc+0x18f0>
    321a:	443010ef          	jal	4e5c <printf>
    exit(1);
    321e:	4505                	li	a0,1
    ...
    322a:	5f250513          	add	a0,a0,1522 # 6818 <malloc+0x1908>
    322e:	42f010ef          	jal	4e5c <printf>
    exit(1);
    3232:	4505                	li	a0,1
    ...
    323e:	5f650513          	add	a0,a0,1526 # 6830 <malloc+0x1920>
    3242:	41b010ef          	jal	4e5c <printf>
    exit(1);
    3246:	4505                	li	a0,1
    ...
    3252:	f9250513          	add	a0,a0,-110 # 61e0 <malloc+0x12d0>
    3256:	407010ef          	jal	4e5c <printf>
    exit(1);
    325a:	4505                	li	a0,1
    ...
    3266:	5ee50513          	add	a0,a0,1518 # 6850 <malloc+0x1940>
    326a:	3f3010ef          	jal	4e5c <printf>
    exit(1);
    326e:	4505                	li	a0,1
    ...
    327a:	60250513          	add	a0,a0,1538 # 6878 <malloc+0x1968>
    327e:	3df010ef          	jal	4e5c <printf>
    exit(1);
    3282:	4505                	li	a0,1
    ...
    328e:	60e50513          	add	a0,a0,1550 # 6898 <malloc+0x1988>
    3292:	3cb010ef          	jal	4e5c <printf>
    exit(1);
    3296:	4505                	li	a0,1
...
000000000000329c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32b2:	60a50513          	add	a0,a0,1546 # 68b8 <malloc+0x19a8>
  ...
  if(chdir("dirfile") == 0){
    ...
    32c6:	5f650513          	add	a0,a0,1526 # 68b8 <malloc+0x19a8>
    32ca:	7b0010ef          	jal	4a7a <chdir>
    32ce:	c569                	beqz	a0,3398 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    32d0:	4581                	li	a1,0
    32d2:	00003517          	auipc	a0,0x3
    32d6:	62e50513          	add	a0,a0,1582 # 6900 <malloc+0x19f0>
  ...
  fd = open(".", 0);
    ...
    3356:	3be50513          	add	a0,a0,958 # 5710 <malloc+0x800>
    335a:	6f0010ef          	jal	4a4a <open>
    335e:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3360:	4605                	li	a2,1
    3362:	00002597          	auipc	a1,0x2
    3366:	d3658593          	add	a1,a1,-714 # 5098 <malloc+0x188>
  ...
  close(fd);
    ...
    338a:	53a50513          	add	a0,a0,1338 # 68c0 <malloc+0x19b0>
    338e:	2cf010ef          	jal	4e5c <printf>
    exit(1);
    3392:	4505                	li	a0,1
    ...
    339e:	54650513          	add	a0,a0,1350 # 68e0 <malloc+0x19d0>
    33a2:	2bb010ef          	jal	4e5c <printf>
    exit(1);
    33a6:	4505                	li	a0,1
    ...
    33b2:	56250513          	add	a0,a0,1378 # 6910 <malloc+0x1a00>
    33b6:	2a7010ef          	jal	4e5c <printf>
    exit(1);
    33ba:	4505                	li	a0,1
    ...
    33c6:	54e50513          	add	a0,a0,1358 # 6910 <malloc+0x1a00>
    33ca:	293010ef          	jal	4e5c <printf>
    exit(1);
    33ce:	4505                	li	a0,1
    ...
    33da:	56250513          	add	a0,a0,1378 # 6938 <malloc+0x1a28>
    33de:	27f010ef          	jal	4e5c <printf>
    exit(1);
    33e2:	4505                	li	a0,1
    ...
    33ee:	57650513          	add	a0,a0,1398 # 6960 <malloc+0x1a50>
    33f2:	26b010ef          	jal	4e5c <printf>
    exit(1);
    33f6:	4505                	li	a0,1
    ...
    3402:	58a50513          	add	a0,a0,1418 # 6988 <malloc+0x1a78>
    3406:	257010ef          	jal	4e5c <printf>
    exit(1);
    340a:	4505                	li	a0,1
    ...
    3416:	59e50513          	add	a0,a0,1438 # 69b0 <malloc+0x1aa0>
    341a:	243010ef          	jal	4e5c <printf>
    exit(1);
    341e:	4505                	li	a0,1
    ...
    342a:	5aa50513          	add	a0,a0,1450 # 69d0 <malloc+0x1ac0>
    342e:	22f010ef          	jal	4e5c <printf>
    exit(1);
    3432:	4505                	li	a0,1
    ...
    343e:	5be50513          	add	a0,a0,1470 # 69f8 <malloc+0x1ae8>
    3442:	21b010ef          	jal	4e5c <printf>
    exit(1);
    3446:	4505                	li	a0,1
...
000000000000344c <iref>:
{
    ...
    346a:	5aaa0a13          	add	s4,s4,1450 # 6a10 <malloc+0x1b00>
    mkdir("");
    346e:	00003497          	auipc	s1,0x3
    3472:	0aa48493          	add	s1,s1,170 # 6518 <malloc+0x1608>
    link("README", "");
    3476:	00002a97          	auipc	s5,0x2
    347a:	d8aa8a93          	add	s5,s5,-630 # 5200 <malloc+0x2f0>
    fd = open("xx", O_CREATE);
    347e:	00003997          	auipc	s3,0x3
    3482:	48a98993          	add	s3,s3,1162 # 6908 <malloc+0x19f8>
    3486:	a835                	j	34c2 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    3488:	85da                	mv	a1,s6
    348a:	00003517          	auipc	a0,0x3
    348e:	58e50513          	add	a0,a0,1422 # 6a18 <malloc+0x1b08>
    3492:	1cb010ef          	jal	4e5c <printf>
      exit(1);
    3496:	4505                	li	a0,1
    ...
    34a2:	59250513          	add	a0,a0,1426 # 6a30 <malloc+0x1b20>
    34a6:	1b7010ef          	jal	4e5c <printf>
      exit(1);
    34aa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    350a:	d2a98993          	add	s3,s3,-726 # 6230 <malloc+0x1320>
    unlink("irefd");
    350e:	00003917          	auipc	s2,0x3
    3512:	50290913          	add	s2,s2,1282 # 6a10 <malloc+0x1b00>
    chdir("..");
    3516:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    352a:	cb250513          	add	a0,a0,-846 # 61d8 <malloc+0x12c8>
...
0000000000003546 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3556:	4f650513          	add	a0,a0,1270 # 6a48 <malloc+0x1b38>
  ...
  if(pid == 0){
    ...
    3572:	4da50513          	add	a0,a0,1242 # 6a48 <malloc+0x1b38>
    ...
    3584:	4e850513          	add	a0,a0,1256 # 6a68 <malloc+0x1b58>
    3588:	0d5010ef          	jal	4e5c <printf>
      exit(1);
    358c:	4505                	li	a0,1
    ...
    3598:	4bc50513          	add	a0,a0,1212 # 6a50 <malloc+0x1b40>
    359c:	0c1010ef          	jal	4e5c <printf>
    exit(1);
    35a0:	4505                	li	a0,1
    ...
    35ac:	31050513          	add	a0,a0,784 # 58b8 <malloc+0x9a8>
    35b0:	0ad010ef          	jal	4e5c <printf>
    exit(1);
    35b4:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    35ca:	48250513          	add	a0,a0,1154 # 6a48 <malloc+0x1b38>
    35ce:	48c010ef          	jal	4a5a <unlink>
    35d2:	c919                	beqz	a0,35e8 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    35d4:	85a6                	mv	a1,s1
    35d6:	00002517          	auipc	a0,0x2
    35da:	4d250513          	add	a0,a0,1234 # 5aa8 <malloc+0xb98>
    35de:	07f010ef          	jal	4e5c <printf>
    exit(1);
    35e2:	4505                	li	a0,1
...
00000000000035f8 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3608:	48c50513          	add	a0,a0,1164 # 6a90 <malloc+0x1b80>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3628:	46c50513          	add	a0,a0,1132 # 6a90 <malloc+0x1b80>
  ...
  sleep(10); // one second
    ...
    3650:	42c50513          	add	a0,a0,1068 # 5a78 <malloc+0xb68>
    3654:	009010ef          	jal	4e5c <printf>
    exit(1);
    3658:	4505                	li	a0,1
    365a:	3b0010ef          	jal	4a0a <exit>
      int fd = open("stopforking", 0);
    365e:	00003497          	auipc	s1,0x3
    3662:	43248493          	add	s1,s1,1074 # 6a90 <malloc+0x1b80>
    3666:	4581                	li	a1,0
    3668:	8526                	mv	a0,s1
    ...
    3682:	41250513          	add	a0,a0,1042 # 6a90 <malloc+0x1b80>
...
0000000000003696 <killstatus>:
{
  ...
  exit(0);
    ...
    36e8:	1d450513          	add	a0,a0,468 # 58b8 <malloc+0x9a8>
    36ec:	770010ef          	jal	4e5c <printf>
      exit(1);
    36f0:	4505                	li	a0,1
    ...
    3702:	3a250513          	add	a0,a0,930 # 6aa0 <malloc+0x1b90>
    3706:	756010ef          	jal	4e5c <printf>
       exit(1);
    370a:	4505                	li	a0,1
...
0000000000003710 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3736:	34650513          	add	a0,a0,838 # 5a78 <malloc+0xb68>
    373a:	722010ef          	jal	4e5c <printf>
    exit(1);
    373e:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3758:	16450513          	add	a0,a0,356 # 58b8 <malloc+0x9a8>
    375c:	700010ef          	jal	4e5c <printf>
    exit(1);
    3760:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3788:	91458593          	add	a1,a1,-1772 # 5098 <malloc+0x188>
    ...
    37aa:	11250513          	add	a0,a0,274 # 58b8 <malloc+0x9a8>
    37ae:	6ae010ef          	jal	4e5c <printf>
     exit(1);
    37b2:	4505                	li	a0,1
    ...
    37be:	30650513          	add	a0,a0,774 # 6ac0 <malloc+0x1bb0>
    37c2:	69a010ef          	jal	4e5c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    37ee:	2ee50513          	add	a0,a0,750 # 6ad8 <malloc+0x1bc8>
    37f2:	66a010ef          	jal	4e5c <printf>
}
  ...
  printf("kill... ");
    ...
    3812:	2e250513          	add	a0,a0,738 # 6af0 <malloc+0x1be0>
    3816:	646010ef          	jal	4e5c <printf>
  kill(pid1);
    381a:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3830:	2d450513          	add	a0,a0,724 # 6b00 <malloc+0x1bf0>
    3834:	628010ef          	jal	4e5c <printf>
  wait(0);
    3838:	4501                	li	a0,0
...
000000000000384c <reparent>:
{
  ...
  exit(0);
    ...
    3890:	02c50513          	add	a0,a0,44 # 58b8 <malloc+0x9a8>
    3894:	5c8010ef          	jal	4e5c <printf>
      exit(1);
    3898:	4505                	li	a0,1
    ...
    38a4:	1a050513          	add	a0,a0,416 # 5a40 <malloc+0xb30>
    38a8:	5b4010ef          	jal	4e5c <printf>
        exit(1);
    38ac:	4505                	li	a0,1
...
00000000000038cc <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    38fe:	0c650513          	add	a0,a0,198 # 59c0 <malloc+0xab0>
    3902:	55a010ef          	jal	4e5c <printf>
    exit(1);
    3906:	4505                	li	a0,1
    ...
    3922:	77a58593          	add	a1,a1,1914 # 5098 <malloc+0x188>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    39c2:	15250513          	add	a0,a0,338 # 6b10 <malloc+0x1c00>
    39c6:	496010ef          	jal	4e5c <printf>
    exit(1);
    39ca:	4505                	li	a0,1
    ...
    39d6:	ee650513          	add	a0,a0,-282 # 58b8 <malloc+0x9a8>
    39da:	482010ef          	jal	4e5c <printf>
    exit(1);
    39de:	4505                	li	a0,1
    ...
    3a12:	12250513          	add	a0,a0,290 # 6b30 <malloc+0x1c20>
    3a16:	446010ef          	jal	4e5c <printf>
    exit(1);
    3a1a:	4505                	li	a0,1
...
0000000000003a26 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3a6a:	6084                	ld	s1,0(s1)
      free(m1);
    3a6c:	422010ef          	jal	4e8e <free>
    while(m1){
    3a70:	fce5                	bnez	s1,3a68 <mem+0x42>
    m1 = malloc(1024*20);
    3a72:	6515                	lui	a0,0x5
    3a74:	49c010ef          	jal	4f10 <malloc>
    if(m1 == 0){
    3a78:	c511                	beqz	a0,3a84 <mem+0x5e>
    free(m1);
    3a7a:	414010ef          	jal	4e8e <free>
    exit(0);
    3a7e:	4501                	li	a0,0
    ...
    3a8a:	0da50513          	add	a0,a0,218 # 6b60 <malloc+0x1c50>
    3a8e:	3ce010ef          	jal	4e5c <printf>
      exit(1);
    3a92:	4505                	li	a0,1
...
0000000000003a9e <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3aba:	0ca50513          	add	a0,a0,202 # 6b80 <malloc+0x1c70>
    3abe:	79d000ef          	jal	4a5a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3ac2:	20200593          	li	a1,514
    3ac6:	00003517          	auipc	a0,0x3
    3aca:	0ba50513          	add	a0,a0,186 # 6b80 <malloc+0x1c70>
  ...
  if(pid == 0) {
    ...
    3b1c:	07850513          	add	a0,a0,120 # 6b90 <malloc+0x1c80>
    3b20:	33c010ef          	jal	4e5c <printf>
    exit(1);
    3b24:	4505                	li	a0,1
    ...
    3b30:	08c50513          	add	a0,a0,140 # 6bb8 <malloc+0x1ca8>
    3b34:	328010ef          	jal	4e5c <printf>
      exit(1);
    3b38:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3b60:	02450513          	add	a0,a0,36 # 6b80 <malloc+0x1c70>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3b98:	04450513          	add	a0,a0,68 # 6bd8 <malloc+0x1cc8>
    3b9c:	2c0010ef          	jal	4e5c <printf>
    exit(1);
    3ba0:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3bc8:	fbc50513          	add	a0,a0,-68 # 6b80 <malloc+0x1c70>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3bea:	01a50513          	add	a0,a0,26 # 6c00 <malloc+0x1cf0>
    3bee:	26e010ef          	jal	4e5c <printf>
    exit(1);
    3bf2:	4505                	li	a0,1
...
0000000000003bfe <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c22:	ffa78793          	add	a5,a5,-6 # 6c18 <malloc+0x1d08>
    3c26:	f6f43823          	sd	a5,-144(s0)
    3c2a:	00003797          	auipc	a5,0x3
    3c2e:	ff678793          	add	a5,a5,-10 # 6c20 <malloc+0x1d10>
    3c32:	f6f43c23          	sd	a5,-136(s0)
    3c36:	00003797          	auipc	a5,0x3
    3c3a:	ff278793          	add	a5,a5,-14 # 6c28 <malloc+0x1d18>
    3c3e:	f8f43023          	sd	a5,-128(s0)
    3c42:	00003797          	auipc	a5,0x3
    3c46:	fee78793          	add	a5,a5,-18 # 6c30 <malloc+0x1d20>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3ca8:	c1450513          	add	a0,a0,-1004 # 58b8 <malloc+0x9a8>
    3cac:	1b0010ef          	jal	4e5c <printf>
      exit(1);
    3cb0:	4505                	li	a0,1
    ...
    3d0a:	c4a50513          	add	a0,a0,-950 # 5950 <malloc+0xa40>
    3d0e:	14e010ef          	jal	4e5c <printf>
        exit(1);
    3d12:	4505                	li	a0,1
    3d14:	4f7000ef          	jal	4a0a <exit>
          printf("write failed %d\n", n);
    3d18:	00003517          	auipc	a0,0x3
    3d1c:	f2050513          	add	a0,a0,-224 # 6c38 <malloc+0x1d28>
    3d20:	13c010ef          	jal	4e5c <printf>
          exit(1);
    3d24:	4505                	li	a0,1
    ...
    3d36:	f1e50513          	add	a0,a0,-226 # 6c50 <malloc+0x1d40>
    3d3a:	122010ef          	jal	4e5c <printf>
          exit(1);
    3d3e:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3da6:	ebe50513          	add	a0,a0,-322 # 6c60 <malloc+0x1d50>
    3daa:	0b2010ef          	jal	4e5c <printf>
      exit(1);
    3dae:	4505                	li	a0,1
...
0000000000003dd2 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e00:	e7cb8b93          	add	s7,s7,-388 # 6c78 <malloc+0x1d68>
  for(i = 0; i < N; i++){
    ...
    3e3a:	e4a50513          	add	a0,a0,-438 # 6c80 <malloc+0x1d70>
    3e3e:	01e010ef          	jal	4e5c <printf>
        exit(1);
    3e42:	4505                	li	a0,1
    ...
    3e50:	e2c50513          	add	a0,a0,-468 # 6c78 <malloc+0x1d68>
  ...
  fd = open(".", 0);
    ...
    3e78:	89c50513          	add	a0,a0,-1892 # 5710 <malloc+0x800>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3ee8:	dbc50513          	add	a0,a0,-580 # 6ca0 <malloc+0x1d90>
    3eec:	771000ef          	jal	4e5c <printf>
        exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f00:	dc450513          	add	a0,a0,-572 # 6cc0 <malloc+0x1db0>
    3f04:	759000ef          	jal	4e5c <printf>
        exit(1);
    3f08:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f2c:	dc050513          	add	a0,a0,-576 # 6ce8 <malloc+0x1dd8>
    3f30:	72d000ef          	jal	4e5c <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f40:	97c50513          	add	a0,a0,-1668 # 58b8 <malloc+0x9a8>
    3f44:	719000ef          	jal	4e5c <printf>
      exit(1);
    3f48:	4505                	li	a0,1
...
0000000000004076 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    408e:	c9650513          	add	a0,a0,-874 # 6d20 <malloc+0x1e10>
    4092:	1c9000ef          	jal	4a5a <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4096:	20200593          	li	a1,514
    409a:	00003517          	auipc	a0,0x3
    409e:	c8650513          	add	a0,a0,-890 # 6d20 <malloc+0x1e10>
  ...
  fd = open("bigfile.dat", 0);
    ...
    40ea:	c3a50513          	add	a0,a0,-966 # 6d20 <malloc+0x1e10>
  ...
  for(i = 0; ; i++){
    ...
    4146:	bee50513          	add	a0,a0,-1042 # 6d30 <malloc+0x1e20>
    414a:	513000ef          	jal	4e5c <printf>
    exit(1);
    414e:	4505                	li	a0,1
    ...
    415a:	bfa50513          	add	a0,a0,-1030 # 6d50 <malloc+0x1e40>
    415e:	4ff000ef          	jal	4e5c <printf>
      exit(1);
    4162:	4505                	li	a0,1
    ...
    416e:	c0650513          	add	a0,a0,-1018 # 6d70 <malloc+0x1e60>
    4172:	4eb000ef          	jal	4e5c <printf>
    exit(1);
    4176:	4505                	li	a0,1
    ...
    4182:	c1250513          	add	a0,a0,-1006 # 6d90 <malloc+0x1e80>
    4186:	4d7000ef          	jal	4e5c <printf>
      exit(1);
    418a:	4505                	li	a0,1
    ...
    4196:	c1e50513          	add	a0,a0,-994 # 6db0 <malloc+0x1ea0>
    419a:	4c3000ef          	jal	4e5c <printf>
      exit(1);
    419e:	4505                	li	a0,1
    ...
    41aa:	c2250513          	add	a0,a0,-990 # 6dc8 <malloc+0x1eb8>
    41ae:	4af000ef          	jal	4e5c <printf>
      exit(1);
    41b2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    41cc:	b5850513          	add	a0,a0,-1192 # 6d20 <malloc+0x1e10>
    ...
    41ec:	c0050513          	add	a0,a0,-1024 # 6de8 <malloc+0x1ed8>
    41f0:	46d000ef          	jal	4e5c <printf>
    exit(1);
    41f4:	4505                	li	a0,1
...
00000000000041fa <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    420a:	c0250513          	add	a0,a0,-1022 # 6e08 <malloc+0x1ef8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4230:	bdc50513          	add	a0,a0,-1060 # 6e08 <malloc+0x1ef8>
  ...
  close(fd);
    ...
    428a:	da250513          	add	a0,a0,-606 # 5028 <malloc+0x118>
    428e:	7b4000ef          	jal	4a42 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4292:	20000593          	li	a1,512
    4296:	00003517          	auipc	a0,0x3
    429a:	b7250513          	add	a0,a0,-1166 # 6e08 <malloc+0x1ef8>
    ...
    42b2:	b6a50513          	add	a0,a0,-1174 # 6e18 <malloc+0x1f08>
    42b6:	3a7000ef          	jal	4e5c <printf>
    exit(1);
    42ba:	4505                	li	a0,1
    ...
    42ca:	b7250513          	add	a0,a0,-1166 # 6e38 <malloc+0x1f28>
    42ce:	38f000ef          	jal	4e5c <printf>
    exit(1);
    42d2:	4505                	li	a0,1
...
00000000000042d8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    42f8:	b6450513          	add	a0,a0,-1180 # 6e58 <malloc+0x1f48>
    42fc:	361000ef          	jal	4e5c <printf>
  for(nfiles = 0; ; nfiles++){
    4300:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4314:	b58c8c93          	add	s9,s9,-1192 # 6e68 <malloc+0x1f58>
    name[0] = 'f';
    ...
    437c:	b0050513          	add	a0,a0,-1280 # 6e78 <malloc+0x1f68>
    4380:	2dd000ef          	jal	4e5c <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    43ea:	ab250513          	add	a0,a0,-1358 # 6e98 <malloc+0x1f88>
    43ee:	26f000ef          	jal	4e5c <printf>
}
    ...
    4438:	a5450513          	add	a0,a0,-1452 # 6e88 <malloc+0x1f78>
    443c:	221000ef          	jal	4e5c <printf>
    close(fd);
    4440:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4462:	a5250513          	add	a0,a0,-1454 # 6eb0 <malloc+0x1fa0>
    4466:	1f7000ef          	jal	4e5c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4486:	a5650513          	add	a0,a0,-1450 # 6ed8 <malloc+0x1fc8>
    448a:	1d3000ef          	jal	4e5c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    44a6:	a1e50513          	add	a0,a0,-1506 # 6ec0 <malloc+0x1fb0>
    44aa:	1b3000ef          	jal	4e5c <printf>
    exit(1);
    44ae:	4505                	li	a0,1
    ...
    44c2:	a2250513          	add	a0,a0,-1502 # 6ee0 <malloc+0x1fd0>
    44c6:	197000ef          	jal	4e5c <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    451a:	9d250513          	add	a0,a0,-1582 # 6ee8 <malloc+0x1fd8>
    451e:	13f000ef          	jal	4e5c <printf>
          return 1;
    4522:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4572:	b2a98993          	add	s3,s3,-1238 # 5098 <malloc+0x188>
      uint64 a = (uint64) sbrk(4096);
    ...
    459c:	9a850513          	add	a0,a0,-1624 # 6f40 <malloc+0x2030>
    45a0:	0bd000ef          	jal	4e5c <printf>
        exit(1);
    45a4:	4505                	li	a0,1
    45a6:	464000ef          	jal	4a0a <exit>
    printf("pipe() failed in countfree()\n");
    45aa:	00003517          	auipc	a0,0x3
    45ae:	95650513          	add	a0,a0,-1706 # 6f00 <malloc+0x1ff0>
    45b2:	0ab000ef          	jal	4e5c <printf>
    exit(1);
    45b6:	4505                	li	a0,1
    45b8:	452000ef          	jal	4a0a <exit>
    printf("fork failed in countfree()\n");
    45bc:	00003517          	auipc	a0,0x3
    45c0:	96450513          	add	a0,a0,-1692 # 6f20 <malloc+0x2010>
    45c4:	099000ef          	jal	4e5c <printf>
    exit(1);
    45c8:	4505                	li	a0,1
  ...
  while(1){
    ...
    45fa:	96a50513          	add	a0,a0,-1686 # 6f60 <malloc+0x2050>
    45fe:	05f000ef          	jal	4e5c <printf>
      exit(1);
    4602:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    464c:	938b8b93          	add	s7,s7,-1736 # 6f80 <malloc+0x2070>
    int free0 = countfree();
    int free1 = 0;
    ...
    4666:	936d0d13          	add	s10,s10,-1738 # 6f98 <malloc+0x2088>
          return 1;
        }
      }
    }
    ...
    466e:	94ec8c93          	add	s9,s9,-1714 # 6fb8 <malloc+0x20a8>
    4672:	a819                	j	4688 <drivetests+0x62>
        printf("usertests slow tests starting\n");
    4674:	856a                	mv	a0,s10
    4676:	7e6000ef          	jal	4e5c <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    472a:	8c258593          	add	a1,a1,-1854 # 6fe8 <malloc+0x20d8>
    472e:	854a                	mv	a0,s2
    ...
    473c:	8b858593          	add	a1,a1,-1864 # 6ff0 <malloc+0x20e0>
    4740:	854a                	mv	a0,s2
    4742:	08c000ef          	jal	47ce <strcmp>
    4746:	cd15                	beqz	a0,4782 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    4748:	00003597          	auipc	a1,0x3
    474c:	8b058593          	add	a1,a1,-1872 # 6ff8 <malloc+0x20e8>
    4750:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    476e:	89650513          	add	a0,a0,-1898 # 7000 <malloc+0x20f0>
    4772:	6ea000ef          	jal	4e5c <printf>
    exit(1);
    4776:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4792:	8a250513          	add	a0,a0,-1886 # 7030 <malloc+0x2120>
    4796:	6c6000ef          	jal	4e5c <printf>
  exit(0);
    479a:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4ae2:	1101                	add	sp,sp,-32
    4ae4:	ec06                	sd	ra,24(sp)
    4ae6:	e822                	sd	s0,16(sp)
    4ae8:	1000                	add	s0,sp,32
    4aea:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4aee:	4605                	li	a2,1
    4af0:	fef40593          	add	a1,s0,-17
    4af4:	f37ff0ef          	jal	4a2a <write>
}
    4af8:	60e2                	ld	ra,24(sp)
    4afa:	6442                	ld	s0,16(sp)
    4afc:	6105                	add	sp,sp,32
    4afe:	8082                	ret

0000000000004b00 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4b00:	7139                	add	sp,sp,-64
    4b02:	fc06                	sd	ra,56(sp)
    4b04:	f822                	sd	s0,48(sp)
    4b06:	f426                	sd	s1,40(sp)
    4b08:	f04a                	sd	s2,32(sp)
    4b0a:	ec4e                	sd	s3,24(sp)
    4b0c:	0080                	add	s0,sp,64
    4b0e:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4b10:	c299                	beqz	a3,4b16 <printint+0x16>
    4b12:	0805c763          	bltz	a1,4ba0 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4b16:	2581                	sext.w	a1,a1
  neg = 0;
    4b18:	4881                	li	a7,0
    4b1a:	fc040693          	add	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4b20:	2601                	sext.w	a2,a2
    4b22:	00003517          	auipc	a0,0x3
    4b26:	8de50513          	add	a0,a0,-1826 # 7400 <digits>
    4b2a:	883a                	mv	a6,a4
    4b2c:	2705                	addw	a4,a4,1
    4b2e:	02c5f7bb          	remuw	a5,a1,a2
    4b32:	1782                	sll	a5,a5,0x20
    4b34:	9381                	srl	a5,a5,0x20
    4b36:	97aa                	add	a5,a5,a0
    4b38:	0007c783          	lbu	a5,0(a5)
    4b3c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4b40:	0005879b          	sext.w	a5,a1
    4b44:	02c5d5bb          	divuw	a1,a1,a2
    4b48:	0685                	add	a3,a3,1
    4b4a:	fec7f0e3          	bgeu	a5,a2,4b2a <printint+0x2a>
  if(neg)
    4b4e:	00088c63          	beqz	a7,4b66 <printint+0x66>
    buf[i++] = '-';
    4b52:	fd070793          	add	a5,a4,-48
    4b56:	00878733          	add	a4,a5,s0
    4b5a:	02d00793          	li	a5,45
    4b5e:	fef70823          	sb	a5,-16(a4)
    4b62:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
    4b66:	02e05663          	blez	a4,4b92 <printint+0x92>
    4b6a:	fc040793          	add	a5,s0,-64
    4b6e:	00e78933          	add	s2,a5,a4
    4b72:	fff78993          	add	s3,a5,-1
    4b76:	99ba                	add	s3,s3,a4
    4b78:	377d                	addw	a4,a4,-1
    4b7a:	1702                	sll	a4,a4,0x20
    4b7c:	9301                	srl	a4,a4,0x20
    4b7e:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4b82:	fff94583          	lbu	a1,-1(s2)
    4b86:	8526                	mv	a0,s1
    4b88:	f5bff0ef          	jal	4ae2 <putc>
  while(--i >= 0)
    4b8c:	197d                	add	s2,s2,-1
    4b8e:	ff391ae3          	bne	s2,s3,4b82 <printint+0x82>
}
    4b92:	70e2                	ld	ra,56(sp)
    4b94:	7442                	ld	s0,48(sp)
    4b96:	74a2                	ld	s1,40(sp)
    4b98:	7902                	ld	s2,32(sp)
    4b9a:	69e2                	ld	s3,24(sp)
    4b9c:	6121                	add	sp,sp,64
    4b9e:	8082                	ret
    x = -xx;
    4ba0:	40b005bb          	negw	a1,a1
    neg = 1;
    4ba4:	4885                	li	a7,1
    x = -xx;
    4ba6:	bf95                	j	4b1a <printint+0x1a>

0000000000004ba8 <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
    ...
    4bbc:	e862                	sd	s8,16(sp)
    4bbe:	e466                	sd	s9,8(sp)
    4bc0:	e06a                	sd	s10,0(sp)
    4bc2:	1080                	add	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4bc4:	0005c903          	lbu	s2,0(a1)
    4bc8:	24090763          	beqz	s2,4e16 <vprintf+0x26e>
    4bcc:	8b2a                	mv	s6,a0
    4bce:	8a2e                	mv	s4,a1
    4bd0:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4bd8:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4bdc:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4be0:	06c00c93          	li	s9,108
    4be4:	a005                	j	4c04 <vprintf+0x5c>
        putc(fd, c0);
    4be6:	85ca                	mv	a1,s2
    4be8:	855a                	mv	a0,s6
    4bea:	ef9ff0ef          	jal	4ae2 <putc>
    4bee:	a019                	j	4bf4 <vprintf+0x4c>
    } else if(state == '%'){
    4bf0:	03598263          	beq	s3,s5,4c14 <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
    4bf4:	2485                	addw	s1,s1,1
    4bf6:	8726                	mv	a4,s1
    4bf8:	009a07b3          	add	a5,s4,s1
    4bfc:	0007c903          	lbu	s2,0(a5)
    4c00:	20090b63          	beqz	s2,4e16 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
    4c04:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4c08:	fe0994e3          	bnez	s3,4bf0 <vprintf+0x48>
      if(c0 == '%'){
    4c0c:	fd579de3          	bne	a5,s5,4be6 <vprintf+0x3e>
        state = '%';
    4c10:	89be                	mv	s3,a5
    4c12:	b7cd                	j	4bf4 <vprintf+0x4c>
      if(c0) c1 = fmt[i+1] & 0xff;
    4c14:	c7c9                	beqz	a5,4c9e <vprintf+0xf6>
    4c16:	00ea06b3          	add	a3,s4,a4
    4c1a:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4c1e:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4c20:	c681                	beqz	a3,4c28 <vprintf+0x80>
    4c22:	9752                	add	a4,a4,s4
    4c24:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4c28:	03878f63          	beq	a5,s8,4c66 <vprintf+0xbe>
      } else if(c0 == 'l' && c1 == 'd'){
    4c2c:	05978963          	beq	a5,s9,4c7e <vprintf+0xd6>
    ...
    4c30:	07500713          	li	a4,117
    4c34:	0ee78363          	beq	a5,a4,4d1a <vprintf+0x172>
    ...
    4c38:	07800713          	li	a4,120
    4c3c:	12e78563          	beq	a5,a4,4d66 <vprintf+0x1be>
    ...
    4c40:	07000713          	li	a4,112
    4c44:	14e78a63          	beq	a5,a4,4d98 <vprintf+0x1f0>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4c48:	07300713          	li	a4,115
    4c4c:	18e78863          	beq	a5,a4,4ddc <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4c50:	02500713          	li	a4,37
    4c54:	04e79563          	bne	a5,a4,4c9e <vprintf+0xf6>
        putc(fd, '%');
    4c58:	02500593          	li	a1,37
    4c5c:	855a                	mv	a0,s6
    4c5e:	e85ff0ef          	jal	4ae2 <putc>
      ...
      state = 0;
    4c62:	4981                	li	s3,0
    4c64:	bf41                	j	4bf4 <vprintf+0x4c>
        printint(fd, va_arg(ap, int), 10, 1);
    4c66:	008b8913          	add	s2,s7,8
    4c6a:	4685                	li	a3,1
    4c6c:	4629                	li	a2,10
    4c6e:	000ba583          	lw	a1,0(s7)
    4c72:	855a                	mv	a0,s6
    4c74:	e8dff0ef          	jal	4b00 <printint>
    4c78:	8bca                	mv	s7,s2
      state = 0;
    4c7a:	4981                	li	s3,0
    4c7c:	bfa5                	j	4bf4 <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'd'){
    4c7e:	06400793          	li	a5,100
    4c82:	02f68963          	beq	a3,a5,4cb4 <vprintf+0x10c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4c86:	06c00793          	li	a5,108
    4c8a:	04f68263          	beq	a3,a5,4cce <vprintf+0x126>
      } else if(c0 == 'l' && c1 == 'u'){
    4c8e:	07500793          	li	a5,117
    4c92:	0af68063          	beq	a3,a5,4d32 <vprintf+0x18a>
      } else if(c0 == 'l' && c1 == 'x'){
    4c96:	07800793          	li	a5,120
    4c9a:	0ef68263          	beq	a3,a5,4d7e <vprintf+0x1d6>
        putc(fd, '%');
    4c9e:	02500593          	li	a1,37
    4ca2:	855a                	mv	a0,s6
    4ca4:	e3fff0ef          	jal	4ae2 <putc>
        putc(fd, c0);
    4ca8:	85ca                	mv	a1,s2
    4caa:	855a                	mv	a0,s6
    4cac:	e37ff0ef          	jal	4ae2 <putc>
      state = 0;
    4cb0:	4981                	li	s3,0
    4cb2:	b789                	j	4bf4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4cc0:	855a                	mv	a0,s6
    4cc2:	e3fff0ef          	jal	4b00 <printint>
        i += 1;
    4cc6:	2485                	addw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4cc8:	8bca                	mv	s7,s2
      state = 0;
    4cca:	4981                	li	s3,0
        i += 1;
    4ccc:	b725                	j	4bf4 <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4cce:	06400793          	li	a5,100
    4cd2:	02f60763          	beq	a2,a5,4d00 <vprintf+0x158>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4cd6:	07500793          	li	a5,117
    4cda:	06f60963          	beq	a2,a5,4d4c <vprintf+0x1a4>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4cde:	07800793          	li	a5,120
    4ce2:	faf61ee3          	bne	a2,a5,4c9e <vprintf+0xf6>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4ce6:	008b8913          	add	s2,s7,8
    4cea:	4681                	li	a3,0
    4cec:	4641                	li	a2,16
    4cee:	000ba583          	lw	a1,0(s7)
    4cf2:	855a                	mv	a0,s6
    4cf4:	e0dff0ef          	jal	4b00 <printint>
        i += 2;
    4cf8:	2489                	addw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4cfa:	8bca                	mv	s7,s2
      state = 0;
    4cfc:	4981                	li	s3,0
        i += 2;
    4cfe:	bddd                	j	4bf4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4d0c:	855a                	mv	a0,s6
    4d0e:	df3ff0ef          	jal	4b00 <printint>
        i += 2;
    4d12:	2489                	addw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d14:	8bca                	mv	s7,s2
      state = 0;
    4d16:	4981                	li	s3,0
        i += 2;
    4d18:	bdf1                	j	4bf4 <vprintf+0x4c>
    ...
    4d26:	855a                	mv	a0,s6
    4d28:	dd9ff0ef          	jal	4b00 <printint>
    4d2c:	8bca                	mv	s7,s2
      state = 0;
    4d2e:	4981                	li	s3,0
    4d30:	b5d1                	j	4bf4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4d32:	008b8913          	add	s2,s7,8
    4d36:	4681                	li	a3,0
    4d38:	4629                	li	a2,10
    4d3a:	000ba583          	lw	a1,0(s7)
    4d3e:	855a                	mv	a0,s6
    4d40:	dc1ff0ef          	jal	4b00 <printint>
        i += 1;
    4d44:	2485                	addw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4d46:	8bca                	mv	s7,s2
      state = 0;
    4d48:	4981                	li	s3,0
        i += 1;
    4d4a:	b56d                	j	4bf4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4d58:	855a                	mv	a0,s6
    4d5a:	da7ff0ef          	jal	4b00 <printint>
        i += 2;
    4d5e:	2489                	addw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4d60:	8bca                	mv	s7,s2
      state = 0;
    4d62:	4981                	li	s3,0
        i += 2;
    4d64:	bd41                	j	4bf4 <vprintf+0x4c>
    ...
    4d72:	855a                	mv	a0,s6
    4d74:	d8dff0ef          	jal	4b00 <printint>
    4d78:	8bca                	mv	s7,s2
      state = 0;
    4d7a:	4981                	li	s3,0
    4d7c:	bda5                	j	4bf4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4d7e:	008b8913          	add	s2,s7,8
    4d82:	4681                	li	a3,0
    4d84:	4641                	li	a2,16
    4d86:	000ba583          	lw	a1,0(s7)
    4d8a:	855a                	mv	a0,s6
    4d8c:	d75ff0ef          	jal	4b00 <printint>
        i += 1;
    4d90:	2485                	addw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    4d92:	8bca                	mv	s7,s2
      state = 0;
    4d94:	4981                	li	s3,0
        i += 1;
    4d96:	bdb9                	j	4bf4 <vprintf+0x4c>
        printptr(fd, va_arg(ap, uint64));
    4d98:	008b8d13          	add	s10,s7,8
    4d9c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4da0:	03000593          	li	a1,48
    4da4:	855a                	mv	a0,s6
    4da6:	d3dff0ef          	jal	4ae2 <putc>
  putc(fd, 'x');
    4daa:	07800593          	li	a1,120
    4dae:	855a                	mv	a0,s6
    4db0:	d33ff0ef          	jal	4ae2 <putc>
    4db4:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4db6:	00002b97          	auipc	s7,0x2
    4dba:	64ab8b93          	add	s7,s7,1610 # 7400 <digits>
    4dbe:	03c9d793          	srl	a5,s3,0x3c
    4dc2:	97de                	add	a5,a5,s7
    4dc4:	0007c583          	lbu	a1,0(a5)
    4dc8:	855a                	mv	a0,s6
    4dca:	d19ff0ef          	jal	4ae2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4dce:	0992                	sll	s3,s3,0x4
    4dd0:	397d                	addw	s2,s2,-1
    4dd2:	fe0916e3          	bnez	s2,4dbe <vprintf+0x216>
        printptr(fd, va_arg(ap, uint64));
    4dd6:	8bea                	mv	s7,s10
      state = 0;
    4dd8:	4981                	li	s3,0
    4dda:	bd29                	j	4bf4 <vprintf+0x4c>
        if((s = va_arg(ap, char*)) == 0)
    4ddc:	008b8993          	add	s3,s7,8
    4de0:	000bb903          	ld	s2,0(s7)
    4de4:	00090f63          	beqz	s2,4e02 <vprintf+0x25a>
        for(; *s; s++)
    4de8:	00094583          	lbu	a1,0(s2)
    4dec:	c195                	beqz	a1,4e10 <vprintf+0x268>
          putc(fd, *s);
    4dee:	855a                	mv	a0,s6
    4df0:	cf3ff0ef          	jal	4ae2 <putc>
        for(; *s; s++)
    4df4:	0905                	add	s2,s2,1
    4df6:	00094583          	lbu	a1,0(s2)
    4dfa:	f9f5                	bnez	a1,4dee <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4dfc:	8bce                	mv	s7,s3
      state = 0;
    4dfe:	4981                	li	s3,0
    4e00:	bbd5                	j	4bf4 <vprintf+0x4c>
          s = "(null)";
    4e02:	00002917          	auipc	s2,0x2
    4e06:	5f690913          	add	s2,s2,1526 # 73f8 <malloc+0x24e8>
        for(; *s; s++)
    4e0a:	02800593          	li	a1,40
    4e0e:	b7c5                	j	4dee <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e10:	8bce                	mv	s7,s3
      state = 0;
    4e12:	4981                	li	s3,0
    4e14:	b3c5                	j	4bf4 <vprintf+0x4c>
    }
  }
}
    4e16:	60e6                	ld	ra,88(sp)
    4e18:	6446                	ld	s0,80(sp)
    4e1a:	64a6                	ld	s1,72(sp)
    4e1c:	6906                	ld	s2,64(sp)
    4e1e:	79e2                	ld	s3,56(sp)
    4e20:	7a42                	ld	s4,48(sp)
    4e22:	7aa2                	ld	s5,40(sp)
    4e24:	7b02                	ld	s6,32(sp)
    4e26:	6be2                	ld	s7,24(sp)
    4e28:	6c42                	ld	s8,16(sp)
    4e2a:	6ca2                	ld	s9,8(sp)
    4e2c:	6d02                	ld	s10,0(sp)
    4e2e:	6125                	add	sp,sp,96
    4e30:	8082                	ret

0000000000004e32 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4e32:	715d                	add	sp,sp,-80
    4e34:	ec06                	sd	ra,24(sp)
    4e36:	e822                	sd	s0,16(sp)
    4e38:	1000                	add	s0,sp,32
    4e3a:	e010                	sd	a2,0(s0)
    4e3c:	e414                	sd	a3,8(s0)
    4e3e:	e818                	sd	a4,16(s0)
    4e40:	ec1c                	sd	a5,24(s0)
    4e42:	03043023          	sd	a6,32(s0)
    4e46:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4e4a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4e4e:	8622                	mv	a2,s0
    4e50:	d59ff0ef          	jal	4ba8 <vprintf>
}
    4e54:	60e2                	ld	ra,24(sp)
    4e56:	6442                	ld	s0,16(sp)
    4e58:	6161                	add	sp,sp,80
    4e5a:	8082                	ret

0000000000004e5c <printf>:

void
printf(const char *fmt, ...)
{
    4e5c:	711d                	add	sp,sp,-96
    4e5e:	ec06                	sd	ra,24(sp)
    4e60:	e822                	sd	s0,16(sp)
    4e62:	1000                	add	s0,sp,32
    4e64:	e40c                	sd	a1,8(s0)
    4e66:	e810                	sd	a2,16(s0)
    4e68:	ec14                	sd	a3,24(s0)
    4e6a:	f018                	sd	a4,32(s0)
    4e6c:	f41c                	sd	a5,40(s0)
    4e6e:	03043823          	sd	a6,48(s0)
    4e72:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4e76:	00840613          	add	a2,s0,8
    4e7a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4e7e:	85aa                	mv	a1,a0
    4e80:	4505                	li	a0,1
    4e82:	d27ff0ef          	jal	4ba8 <vprintf>
}
    4e86:	60e2                	ld	ra,24(sp)
    4e88:	6442                	ld	s0,16(sp)
    4e8a:	6125                	add	sp,sp,96
    4e8c:	8082                	ret

0000000000004e8e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    4e8e:	1141                	add	sp,sp,-16
    4e90:	e422                	sd	s0,8(sp)
    4e92:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4e94:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4e98:	00003797          	auipc	a5,0x3
    4e9c:	5b87b783          	ld	a5,1464(a5) # 8450 <freep>
    4ea0:	a02d                	j	4eca <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4ea2:	4618                	lw	a4,8(a2)
    4ea4:	9f2d                	addw	a4,a4,a1
    4ea6:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4eaa:	6398                	ld	a4,0(a5)
    4eac:	6310                	ld	a2,0(a4)
    4eae:	a83d                	j	4eec <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4eb0:	ff852703          	lw	a4,-8(a0)
    4eb4:	9f31                	addw	a4,a4,a2
    4eb6:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    4eb8:	ff053683          	ld	a3,-16(a0)
    4ebc:	a091                	j	4f00 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4ebe:	6398                	ld	a4,0(a5)
    4ec0:	00e7e463          	bltu	a5,a4,4ec8 <free+0x3a>
    4ec4:	00e6ea63          	bltu	a3,a4,4ed8 <free+0x4a>
{
    4ec8:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4eca:	fed7fae3          	bgeu	a5,a3,4ebe <free+0x30>
    4ece:	6398                	ld	a4,0(a5)
    4ed0:	00e6e463          	bltu	a3,a4,4ed8 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4ed4:	fee7eae3          	bltu	a5,a4,4ec8 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    4ed8:	ff852583          	lw	a1,-8(a0)
    4edc:	6390                	ld	a2,0(a5)
    4ede:	02059813          	sll	a6,a1,0x20
    4ee2:	01c85713          	srl	a4,a6,0x1c
    4ee6:	9736                	add	a4,a4,a3
    4ee8:	fae60de3          	beq	a2,a4,4ea2 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    4eec:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4ef0:	4790                	lw	a2,8(a5)
    4ef2:	02061593          	sll	a1,a2,0x20
    4ef6:	01c5d713          	srl	a4,a1,0x1c
    4efa:	973e                	add	a4,a4,a5
    4efc:	fae68ae3          	beq	a3,a4,4eb0 <free+0x22>
    p->s.ptr = bp->s.ptr;
    4f00:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    4f02:	00003717          	auipc	a4,0x3
    4f06:	54f73723          	sd	a5,1358(a4) # 8450 <freep>
}
    4f0a:	6422                	ld	s0,8(sp)
    4f0c:	0141                	add	sp,sp,16
    4f0e:	8082                	ret

0000000000004f10 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    4f10:	7139                	add	sp,sp,-64
    4f12:	fc06                	sd	ra,56(sp)
    4f14:	f822                	sd	s0,48(sp)
    4f16:	f426                	sd	s1,40(sp)
    4f18:	f04a                	sd	s2,32(sp)
    4f1a:	ec4e                	sd	s3,24(sp)
    4f1c:	e852                	sd	s4,16(sp)
    4f1e:	e456                	sd	s5,8(sp)
    4f20:	e05a                	sd	s6,0(sp)
    4f22:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4f24:	02051493          	sll	s1,a0,0x20
    4f28:	9081                	srl	s1,s1,0x20
    4f2a:	04bd                	add	s1,s1,15
    4f2c:	8091                	srl	s1,s1,0x4
    4f2e:	0014899b          	addw	s3,s1,1
    4f32:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    4f34:	00003517          	auipc	a0,0x3
    4f38:	51c53503          	ld	a0,1308(a0) # 8450 <freep>
    4f3c:	c515                	beqz	a0,4f68 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4f3e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4f40:	4798                	lw	a4,8(a5)
    4f42:	02977f63          	bgeu	a4,s1,4f80 <malloc+0x70>
  if(nu < 4096)
    4f46:	8a4e                	mv	s4,s3
    4f48:	0009871b          	sext.w	a4,s3
    4f4c:	6685                	lui	a3,0x1
    4f4e:	00d77363          	bgeu	a4,a3,4f54 <malloc+0x44>
    4f52:	6a05                	lui	s4,0x1
    4f54:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4f58:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4f5c:	00003917          	auipc	s2,0x3
    4f60:	4f490913          	add	s2,s2,1268 # 8450 <freep>
  if(p == (char*)-1)
    4f64:	5afd                	li	s5,-1
    4f66:	a885                	j	4fd6 <malloc+0xc6>
    base.s.ptr = freep = prevp = &base;
    4f68:	0000a797          	auipc	a5,0xa
    4f6c:	d1078793          	add	a5,a5,-752 # ec78 <base>
    4f70:	00003717          	auipc	a4,0x3
    4f74:	4ef73023          	sd	a5,1248(a4) # 8450 <freep>
    4f78:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    4f7a:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    4f7e:	b7e1                	j	4f46 <malloc+0x36>
      if(p->s.size == nunits)
    4f80:	02e48c63          	beq	s1,a4,4fb8 <malloc+0xa8>
        p->s.size -= nunits;
    4f84:	4137073b          	subw	a4,a4,s3
    4f88:	c798                	sw	a4,8(a5)
        p += p->s.size;
    4f8a:	02071693          	sll	a3,a4,0x20
    4f8e:	01c6d713          	srl	a4,a3,0x1c
    4f92:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    4f94:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    4f98:	00003717          	auipc	a4,0x3
    4f9c:	4aa73c23          	sd	a0,1208(a4) # 8450 <freep>
      return (void*)(p + 1);
    4fa0:	01078513          	add	a0,a5,16
    ...
    4faa:	7902                	ld	s2,32(sp)
    4fac:	69e2                	ld	s3,24(sp)
    4fae:	6a42                	ld	s4,16(sp)
    4fb0:	6aa2                	ld	s5,8(sp)
    4fb2:	6b02                	ld	s6,0(sp)
    4fb4:	6121                	add	sp,sp,64
    4fb6:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    4fb8:	6398                	ld	a4,0(a5)
    4fba:	e118                	sd	a4,0(a0)
    4fbc:	bff1                	j	4f98 <malloc+0x88>
  hp->s.size = nu;
    4fbe:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    4fc2:	0541                	add	a0,a0,16
    4fc4:	ecbff0ef          	jal	4e8e <free>
  return freep;
    4fc8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    4fcc:	dd61                	beqz	a0,4fa4 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4fce:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4fd0:	4798                	lw	a4,8(a5)
    4fd2:	fa9777e3          	bgeu	a4,s1,4f80 <malloc+0x70>
    if(p == freep)
    4fd6:	00093703          	ld	a4,0(s2)
    4fda:	853e                	mv	a0,a5
    4fdc:	fef719e3          	bne	a4,a5,4fce <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
    4fe0:	8552                	mv	a0,s4
    4fe2:	ab1ff0ef          	jal	4a92 <sbrk>
  if(p == (char*)-1)
    4fe6:	fd551ce3          	bne	a0,s5,4fbe <malloc+0xae>
        return 0;
    4fea:	4501                	li	a0,0
    4fec:	bf65                	j	4fa4 <malloc+0x94>
