...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	1be58593          	add	a1,a1,446 # 11d0 <malloc+0xe0>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	18458593          	add	a1,a1,388 # 11d8 <malloc+0xe8>
      5c:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	15e50513          	add	a0,a0,350 # 11e0 <malloc+0xf0>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	23670713          	add	a4,a4,566 # 12e0 <malloc+0x1f0>
    ...
    panic("runcmd");
      ...
      c4:	12850513          	add	a0,a0,296 # 11e8 <malloc+0xf8>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      de:	11658593          	add	a1,a1,278 # 11f0 <malloc+0x100>
      e2:	4509                	li	a0,2
      e4:	72f000ef          	jal	1012 <fprintf>
  exit(0);
      e8:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     112:	0f258593          	add	a1,a1,242 # 1200 <malloc+0x110>
     116:	4509                	li	a0,2
     118:	6fb000ef          	jal	1012 <fprintf>
      exit(1);
     11c:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     174:	0a050513          	add	a0,a0,160 # 1210 <malloc+0x120>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d2:	d6ab8b93          	add	s7,s7,-662 # 1238 <malloc+0x148>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e4:	d3850513          	add	a0,a0,-712 # 1218 <malloc+0x128>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5b0:	c9460613          	add	a2,a2,-876 # 1240 <malloc+0x150>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5d4:	c90b0b13          	add	s6,s6,-880 # 1260 <malloc+0x170>
  ...
  return ret;
     ...
     60a:	c4250513          	add	a0,a0,-958 # 1248 <malloc+0x158>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     65c:	bf850513          	add	a0,a0,-1032 # 1250 <malloc+0x160>
...
0000000000000672 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     68e:	bde60613          	add	a2,a2,-1058 # 1268 <malloc+0x178>
     692:	85ce                	mv	a1,s3
     694:	854a                	mv	a0,s2
...
00000000000006cc <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6ea:	b8aa0a13          	add	s4,s4,-1142 # 1270 <malloc+0x180>
  ...
  if(peek(ps, es, ";")){
     ...
     714:	b6860613          	add	a2,a2,-1176 # 1278 <malloc+0x188>
     718:	85ce                	mv	a1,s3
     71a:	854a                	mv	a0,s2
...
0000000000000754 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     76a:	ada60613          	add	a2,a2,-1318 # 1240 <malloc+0x150>
  ...
  if(!peek(ps, es, ")"))
     ...
     78e:	b0660613          	add	a2,a2,-1274 # 1290 <malloc+0x1a0>
     792:	85ca                	mv	a1,s2
     794:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7c4:	ac050513          	add	a0,a0,-1344 # 1280 <malloc+0x190>
     7c8:	883ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7cc:	00001517          	auipc	a0,0x1
     7d0:	acc50513          	add	a0,a0,-1332 # 1298 <malloc+0x1a8>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f8:	b0470713          	add	a4,a4,-1276 # 12f8 <malloc+0x208>
...
0000000000000858 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     884:	a3060613          	add	a2,a2,-1488 # 12b0 <malloc+0x1c0>
     888:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8b2:	a0a58593          	add	a1,a1,-1526 # 12b8 <malloc+0x1c8>
     8b6:	4509                	li	a0,2
     8b8:	75a000ef          	jal	1012 <fprintf>
    panic("syntax");
     8bc:	00001517          	auipc	a0,0x1
     8c0:	98c50513          	add	a0,a0,-1652 # 1248 <malloc+0x158>
...
00000000000008c8 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8dc:	9f048493          	add	s1,s1,-1552 # 12c8 <malloc+0x1d8>
     8e0:	4589                	li	a1,2
     8e2:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     976:	95e58593          	add	a1,a1,-1698 # 12d0 <malloc+0x1e0>
     97a:	4509                	li	a0,2
     97c:	696000ef          	jal	1012 <fprintf>
...
putc(int fd, char c)
{
     ...
     cc8:	1000                	add	s0,sp,32
     cca:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     cce:	4605                	li	a2,1
     cd0:	fef40593          	add	a1,s0,-17
     cd4:	f4fff0ef          	jal	c22 <write>
}
     cd8:	60e2                	ld	ra,24(sp)
     cda:	6442                	ld	s0,16(sp)
     cdc:	6105                	add	sp,sp,32
     cde:	8082                	ret

0000000000000ce0 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
     ce0:	7139                	add	sp,sp,-64
     ce2:	fc06                	sd	ra,56(sp)
     ce4:	f822                	sd	s0,48(sp)
     ce6:	f426                	sd	s1,40(sp)
     ce8:	f04a                	sd	s2,32(sp)
     cea:	ec4e                	sd	s3,24(sp)
     cec:	0080                	add	s0,sp,64
     cee:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
     cf0:	c299                	beqz	a3,cf6 <printint+0x16>
     cf2:	0805c763          	bltz	a1,d80 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     cf6:	2581                	sext.w	a1,a1
  neg = 0;
     cf8:	4881                	li	a7,0
     cfa:	fc040693          	add	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     d00:	2601                	sext.w	a2,a2
     d02:	00000517          	auipc	a0,0x0
     d06:	61650513          	add	a0,a0,1558 # 1318 <digits>
     d0a:	883a                	mv	a6,a4
     d0c:	2705                	addw	a4,a4,1
     d0e:	02c5f7bb          	remuw	a5,a1,a2
     d12:	1782                	sll	a5,a5,0x20
     d14:	9381                	srl	a5,a5,0x20
     d16:	97aa                	add	a5,a5,a0
     d18:	0007c783          	lbu	a5,0(a5)
     d1c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     d20:	0005879b          	sext.w	a5,a1
     d24:	02c5d5bb          	divuw	a1,a1,a2
     d28:	0685                	add	a3,a3,1
     d2a:	fec7f0e3          	bgeu	a5,a2,d0a <printint+0x2a>
  if(neg)
     d2e:	00088c63          	beqz	a7,d46 <printint+0x66>
    buf[i++] = '-';
     d32:	fd070793          	add	a5,a4,-48
     d36:	00878733          	add	a4,a5,s0
     d3a:	02d00793          	li	a5,45
     d3e:	fef70823          	sb	a5,-16(a4)
     d42:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
     d46:	02e05663          	blez	a4,d72 <printint+0x92>
     d4a:	fc040793          	add	a5,s0,-64
     d4e:	00e78933          	add	s2,a5,a4
     d52:	fff78993          	add	s3,a5,-1
     d56:	99ba                	add	s3,s3,a4
     d58:	377d                	addw	a4,a4,-1
     d5a:	1702                	sll	a4,a4,0x20
     d5c:	9301                	srl	a4,a4,0x20
     d5e:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     d62:	fff94583          	lbu	a1,-1(s2)
     d66:	8526                	mv	a0,s1
     d68:	f5bff0ef          	jal	cc2 <putc>
  while(--i >= 0)
     d6c:	197d                	add	s2,s2,-1
     d6e:	ff391ae3          	bne	s2,s3,d62 <printint+0x82>
}
     d72:	70e2                	ld	ra,56(sp)
     d74:	7442                	ld	s0,48(sp)
     d76:	74a2                	ld	s1,40(sp)
     d78:	7902                	ld	s2,32(sp)
     d7a:	69e2                	ld	s3,24(sp)
     d7c:	6121                	add	sp,sp,64
     d7e:	8082                	ret
    x = -xx;
     d80:	40b005bb          	negw	a1,a1
    neg = 1;
     d84:	4885                	li	a7,1
    x = -xx;
     d86:	bf95                	j	cfa <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     d9e:	e466                	sd	s9,8(sp)
     da0:	e06a                	sd	s10,0(sp)
     da2:	1080                	add	s0,sp,96
  char *s;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     da8:	24090763          	beqz	s2,ff6 <vprintf+0x26e>
     dac:	8b2a                	mv	s6,a0
     dae:	8a2e                	mv	s4,a1
     db0:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dc4:	a005                	j	de4 <vprintf+0x5c>
        putc(fd, c0);
     dc6:	85ca                	mv	a1,s2
     dc8:	855a                	mv	a0,s6
     dca:	ef9ff0ef          	jal	cc2 <putc>
     dce:	a019                	j	dd4 <vprintf+0x4c>
    } else if(state == '%'){
     dd0:	03598263          	beq	s3,s5,df4 <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
     dd4:	2485                	addw	s1,s1,1
     dd6:	8726                	mv	a4,s1
     dd8:	009a07b3          	add	a5,s4,s1
     ddc:	0007c903          	lbu	s2,0(a5)
     de0:	20090b63          	beqz	s2,ff6 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
     de4:	0009079b          	sext.w	a5,s2
    if(state == 0){
     de8:	fe0994e3          	bnez	s3,dd0 <vprintf+0x48>
      if(c0 == '%'){
     dec:	fd579de3          	bne	a5,s5,dc6 <vprintf+0x3e>
        state = '%';
     df0:	89be                	mv	s3,a5
     df2:	b7cd                	j	dd4 <vprintf+0x4c>
      if(c0) c1 = fmt[i+1] & 0xff;
     df4:	c7c9                	beqz	a5,e7e <vprintf+0xf6>
     df6:	00ea06b3          	add	a3,s4,a4
     dfa:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     dfe:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e00:	c681                	beqz	a3,e08 <vprintf+0x80>
     e02:	9752                	add	a4,a4,s4
     e04:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e08:	03878f63          	beq	a5,s8,e46 <vprintf+0xbe>
      } else if(c0 == 'l' && c1 == 'd'){
     e0c:	05978963          	beq	a5,s9,e5e <vprintf+0xd6>
     ...
     e10:	07500713          	li	a4,117
     e14:	0ee78363          	beq	a5,a4,efa <vprintf+0x172>
     ...
     e1c:	12e78563          	beq	a5,a4,f46 <vprintf+0x1be>
     ...
     e24:	14e78a63          	beq	a5,a4,f78 <vprintf+0x1f0>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     e28:	07300713          	li	a4,115
     e2c:	18e78863          	beq	a5,a4,fbc <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     e30:	02500713          	li	a4,37
     e34:	04e79563          	bne	a5,a4,e7e <vprintf+0xf6>
        putc(fd, '%');
     e38:	02500593          	li	a1,37
     e3c:	855a                	mv	a0,s6
     e3e:	e85ff0ef          	jal	cc2 <putc>
     ...
     e52:	855a                	mv	a0,s6
     e54:	e8dff0ef          	jal	ce0 <printint>
     e58:	8bca                	mv	s7,s2
      state = 0;
     e5a:	4981                	li	s3,0
     e5c:	bfa5                	j	dd4 <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'd'){
     e5e:	06400793          	li	a5,100
     e62:	02f68963          	beq	a3,a5,e94 <vprintf+0x10c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e66:	06c00793          	li	a5,108
     e6a:	04f68263          	beq	a3,a5,eae <vprintf+0x126>
      } else if(c0 == 'l' && c1 == 'u'){
     e6e:	07500793          	li	a5,117
     e72:	0af68063          	beq	a3,a5,f12 <vprintf+0x18a>
      } else if(c0 == 'l' && c1 == 'x'){
     e76:	07800793          	li	a5,120
     e7a:	0ef68263          	beq	a3,a5,f5e <vprintf+0x1d6>
        putc(fd, '%');
     e7e:	02500593          	li	a1,37
     e82:	855a                	mv	a0,s6
     e84:	e3fff0ef          	jal	cc2 <putc>
        putc(fd, c0);
     e88:	85ca                	mv	a1,s2
     e8a:	855a                	mv	a0,s6
     e8c:	e37ff0ef          	jal	cc2 <putc>
      state = 0;
     e90:	4981                	li	s3,0
     e92:	b789                	j	dd4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 1);
     e94:	008b8913          	add	s2,s7,8
     e98:	4685                	li	a3,1
     e9a:	4629                	li	a2,10
     e9c:	000ba583          	lw	a1,0(s7)
     ea0:	855a                	mv	a0,s6
     ea2:	e3fff0ef          	jal	ce0 <printint>
        i += 1;
     ea6:	2485                	addw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
     ea8:	8bca                	mv	s7,s2
      state = 0;
     eaa:	4981                	li	s3,0
        i += 1;
     eac:	b725                	j	dd4 <vprintf+0x4c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eae:	06400793          	li	a5,100
     eb2:	02f60763          	beq	a2,a5,ee0 <vprintf+0x158>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     eb6:	07500793          	li	a5,117
     eba:	06f60963          	beq	a2,a5,f2c <vprintf+0x1a4>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     ebe:	07800793          	li	a5,120
     ec2:	faf61ee3          	bne	a2,a5,e7e <vprintf+0xf6>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ec6:	008b8913          	add	s2,s7,8
     eca:	4681                	li	a3,0
     ecc:	4641                	li	a2,16
     ece:	000ba583          	lw	a1,0(s7)
     ed2:	855a                	mv	a0,s6
     ed4:	e0dff0ef          	jal	ce0 <printint>
        i += 2;
     ed8:	2489                	addw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
     eda:	8bca                	mv	s7,s2
      state = 0;
     edc:	4981                	li	s3,0
        i += 2;
     ede:	bddd                	j	dd4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ee0:	008b8913          	add	s2,s7,8
     ee4:	4685                	li	a3,1
     ee6:	4629                	li	a2,10
     ee8:	000ba583          	lw	a1,0(s7)
     eec:	855a                	mv	a0,s6
     eee:	df3ff0ef          	jal	ce0 <printint>
        i += 2;
     ef2:	2489                	addw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
     ef4:	8bca                	mv	s7,s2
      state = 0;
     ef6:	4981                	li	s3,0
        i += 2;
     ef8:	bdf1                	j	dd4 <vprintf+0x4c>
     ...
     f06:	855a                	mv	a0,s6
     f08:	dd9ff0ef          	jal	ce0 <printint>
     f0c:	8bca                	mv	s7,s2
      state = 0;
     f0e:	4981                	li	s3,0
     f10:	b5d1                	j	dd4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f1e:	855a                	mv	a0,s6
     f20:	dc1ff0ef          	jal	ce0 <printint>
        i += 1;
     f24:	2485                	addw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
     f26:	8bca                	mv	s7,s2
      state = 0;
     f28:	4981                	li	s3,0
        i += 1;
     f2a:	b56d                	j	dd4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 10, 0);
     f2c:	008b8913          	add	s2,s7,8
     f30:	4681                	li	a3,0
     f32:	4629                	li	a2,10
     f34:	000ba583          	lw	a1,0(s7)
     f38:	855a                	mv	a0,s6
     f3a:	da7ff0ef          	jal	ce0 <printint>
        i += 2;
     f3e:	2489                	addw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
     f40:	8bca                	mv	s7,s2
      state = 0;
     f42:	4981                	li	s3,0
        i += 2;
     f44:	bd41                	j	dd4 <vprintf+0x4c>
     ...
     f52:	855a                	mv	a0,s6
     f54:	d8dff0ef          	jal	ce0 <printint>
     f58:	8bca                	mv	s7,s2
      state = 0;
     f5a:	4981                	li	s3,0
     f5c:	bda5                	j	dd4 <vprintf+0x4c>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f74:	4981                	li	s3,0
        i += 1;
     f76:	bdb9                	j	dd4 <vprintf+0x4c>
        printptr(fd, va_arg(ap, uint64));
     f78:	008b8d13          	add	s10,s7,8
     f7c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     f80:	03000593          	li	a1,48
     f84:	855a                	mv	a0,s6
     f86:	d3dff0ef          	jal	cc2 <putc>
  putc(fd, 'x');
     f8a:	07800593          	li	a1,120
     f8e:	855a                	mv	a0,s6
     f90:	d33ff0ef          	jal	cc2 <putc>
     f94:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f96:	00000b97          	auipc	s7,0x0
     f9a:	382b8b93          	add	s7,s7,898 # 1318 <digits>
     f9e:	03c9d793          	srl	a5,s3,0x3c
     fa2:	97de                	add	a5,a5,s7
     fa4:	0007c583          	lbu	a1,0(a5)
     fa8:	855a                	mv	a0,s6
     faa:	d19ff0ef          	jal	cc2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fae:	0992                	sll	s3,s3,0x4
     fb0:	397d                	addw	s2,s2,-1
     fb2:	fe0916e3          	bnez	s2,f9e <vprintf+0x216>
        printptr(fd, va_arg(ap, uint64));
     fb6:	8bea                	mv	s7,s10
      state = 0;
     fb8:	4981                	li	s3,0
     fba:	bd29                	j	dd4 <vprintf+0x4c>
        if((s = va_arg(ap, char*)) == 0)
     fbc:	008b8993          	add	s3,s7,8
     fc0:	000bb903          	ld	s2,0(s7)
     fc4:	00090f63          	beqz	s2,fe2 <vprintf+0x25a>
        for(; *s; s++)
     fc8:	00094583          	lbu	a1,0(s2)
     fcc:	c195                	beqz	a1,ff0 <vprintf+0x268>
          putc(fd, *s);
     fce:	855a                	mv	a0,s6
     fd0:	cf3ff0ef          	jal	cc2 <putc>
        for(; *s; s++)
     fd4:	0905                	add	s2,s2,1
     fd6:	00094583          	lbu	a1,0(s2)
     fda:	f9f5                	bnez	a1,fce <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     fdc:	8bce                	mv	s7,s3
      state = 0;
     fde:	4981                	li	s3,0
     fe0:	bbd5                	j	dd4 <vprintf+0x4c>
          s = "(null)";
     fe2:	00000917          	auipc	s2,0x0
     fe6:	32e90913          	add	s2,s2,814 # 1310 <malloc+0x220>
        for(; *s; s++)
     fea:	02800593          	li	a1,40
     fee:	b7c5                	j	fce <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     ff0:	8bce                	mv	s7,s3
      state = 0;
     ff2:	4981                	li	s3,0
     ff4:	b3c5                	j	dd4 <vprintf+0x4c>
    }
  }
}
    ...
    1008:	6c42                	ld	s8,16(sp)
    100a:	6ca2                	ld	s9,8(sp)
    100c:	6d02                	ld	s10,0(sp)
    100e:	6125                	add	sp,sp,96
    1010:	8082                	ret
...
{
    1012:	715d                	add	sp,sp,-80
    1014:	ec06                	sd	ra,24(sp)
    1016:	e822                	sd	s0,16(sp)
    1018:	1000                	add	s0,sp,32
  ...
  vprintf(fd, fmt, ap);
    102e:	8622                	mv	a2,s0
    1030:	d59ff0ef          	jal	d88 <vprintf>
}
    1034:	60e2                	ld	ra,24(sp)
    1036:	6442                	ld	s0,16(sp)
    1038:	6161                	add	sp,sp,80
    103a:	8082                	ret
...
printf(const char *fmt, ...)
{
  ...
  va_start(ap, fmt);
    1056:	00840613          	add	a2,s0,8
    105a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    105e:	85aa                	mv	a1,a0
    1060:	4505                	li	a0,1
    1062:	d27ff0ef          	jal	d88 <vprintf>
}
    1066:	60e2                	ld	ra,24(sp)
    1068:	6442                	ld	s0,16(sp)
    106a:	6125                	add	sp,sp,96
    106c:	8082                	ret
...
free(void *ap)
{
    106e:	1141                	add	sp,sp,-16
    1070:	e422                	sd	s0,8(sp)
    1072:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1074:	ff050693          	add	a3,a0,-16
    ...
    10a4:	00e6ea63          	bltu	a3,a4,10b8 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    10be:	02059813          	sll	a6,a1,0x20
    10c2:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    10d2:	02061593          	sll	a1,a2,0x20
    10d6:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    ...
    1102:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1104:	02051493          	sll	s1,a0,0x20
    1108:	9081                	srl	s1,s1,0x20
    110a:	04bd                	add	s1,s1,15
    110c:	8091                	srl	s1,s1,0x4
    110e:	0014899b          	addw	s3,s1,1
    1112:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    1114:	00001517          	auipc	a0,0x1
    1118:	efc53503          	ld	a0,-260(a0) # 2010 <freep>
    111c:	c515                	beqz	a0,1148 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1122:	02977f63          	bgeu	a4,s1,1160 <malloc+0x70>
  if(nu < 4096)
    1126:	8a4e                	mv	s4,s3
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1140:	ed490913          	add	s2,s2,-300 # 2010 <freep>
  if(p == (char*)-1)
    1144:	5afd                	li	s5,-1
    1146:	a885                	j	11b6 <malloc+0xc6>
    base.s.ptr = freep = prevp = &base;
    1148:	00001797          	auipc	a5,0x1
    114c:	f4078793          	add	a5,a5,-192 # 2088 <base>
    ...
    if(p->s.size >= nunits){
    115e:	b7e1                	j	1126 <malloc+0x36>
      if(p->s.size == nunits)
    1160:	02e48c63          	beq	s1,a4,1198 <malloc+0xa8>
        p->s.size -= nunits;
    1164:	4137073b          	subw	a4,a4,s3
    1168:	c798                	sw	a4,8(a5)
        p += p->s.size;
    116a:	02071693          	sll	a3,a4,0x20
    116e:	01c6d713          	srl	a4,a3,0x1c
    1172:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1174:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1178:	00001717          	auipc	a4,0x1
    117c:	e8a73c23          	sd	a0,-360(a4) # 2010 <freep>
      return (void*)(p + 1);
    1180:	01078513          	add	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    1184:	70e2                	ld	ra,56(sp)
    1186:	7442                	ld	s0,48(sp)
    1188:	74a2                	ld	s1,40(sp)
    118a:	7902                	ld	s2,32(sp)
    118c:	69e2                	ld	s3,24(sp)
    118e:	6a42                	ld	s4,16(sp)
    1190:	6aa2                	ld	s5,8(sp)
    1192:	6b02                	ld	s6,0(sp)
    1194:	6121                	add	sp,sp,64
    1196:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    1198:	6398                	ld	a4,0(a5)
    119a:	e118                	sd	a4,0(a0)
    119c:	bff1                	j	1178 <malloc+0x88>
  hp->s.size = nu;
    119e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11a2:	0541                	add	a0,a0,16
    11a4:	ecbff0ef          	jal	106e <free>
  return freep;
    11a8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11ac:	dd61                	beqz	a0,1184 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11ae:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11b0:	4798                	lw	a4,8(a5)
    11b2:	fa9777e3          	bgeu	a4,s1,1160 <malloc+0x70>
    if(p == freep)
    11b6:	00093703          	ld	a4,0(s2)
    11ba:	853e                	mv	a0,a5
    11bc:	fef719e3          	bne	a4,a5,11ae <malloc+0xbe>
  p = sbrk(nu * sizeof(Header));
    11c0:	8552                	mv	a0,s4
    11c2:	ac9ff0ef          	jal	c8a <sbrk>
  if(p == (char*)-1)
    11c6:	fd551ce3          	bne	a0,s5,119e <malloc+0xae>
        return 0;
    11ca:	4501                	li	a0,0
    11cc:	bf65                	j	1184 <malloc+0x94>
